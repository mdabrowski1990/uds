...
async_listener1 = can.AsyncBufferedReader()
# listener2 = can.BufferedReader()
notifier1 = can.Notifier(bus=bus1, listeners=[listener1, async_listener1])
