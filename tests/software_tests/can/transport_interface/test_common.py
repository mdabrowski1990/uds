...
class TestAbstractCanTransportInterface:
    ...
    def setup_method(self):
        self.mock_can_transport_interface = Mock(
            spec=AbstractCanTransportInterface, flow_control_parameters_generator=MagicMock()
        )
        # patching
        self._patcher_abstract_transport_interface_init = patch(
            f"{SCRIPT_LOCATION}.AbstractTransportInterface.__init__"
        )
        ...
        self._patcher_can_packet_type_is_initial_packet_type = patch(
            f"{SCRIPT_LOCATION}.CanPacketType.is_initial_packet_type"
        )
    ...
    @pytest.mark.parametrize(
        "network_manager, addressing_information",
        [
            (Mock(), Mock()),
    ...
    def test_init__mandatory_args(self, network_manager, addressing_information):
        assert (
            AbstractCanTransportInterface.__init__(
    ...
    def test_init__all_args(
        ...
        self.mock_can_transport_interface.segmenter = self.mock_can_segmenter.return_value
        self.mock_abstract_transport_interface_init.assert_called_once_with(network_manager=network_manager)
        self.mock_can_segmenter.assert_called_once_with(
            addressing_information=addressing_information, **segmenter_configuration
        )
    ...
    def test_can_version__get(self):
        ...
        assert (
            AbstractCanTransportInterface.can_version.fget(self.mock_can_transport_interface)
    ...
    def test_bitrate_switch__get(self):
        ...
        assert (
            AbstractCanTransportInterface.bitrate_switch.fget(self.mock_can_transport_interface)
    ...
    def test_min_dlc__get(self):
        assert (
            AbstractCanTransportInterface.min_dlc.fget(self.mock_can_transport_interface)
    ...
    def test_flow_control_parameters_generator__get(self):
        ...
        assert (
            AbstractCanTransportInterface.flow_control_parameters_generator.fget(self.mock_can_transport_interface)
    ...
    def test_flow_control_parameters_generator__set__type_error(self, mock_isinstance, value):
        mock_isinstance.return_value = False
        with pytest.raises(TypeError):
            AbstractCanTransportInterface.flow_control_parameters_generator.fset(
                self.mock_can_transport_interface, value
            )
    ...
    def test_n_as_measured__get(self):
        ...
        assert (
            AbstractCanTransportInterface.n_as_measured.fget(self.mock_can_transport_interface)
    ...
    def test_n_ar_measured__get(self):
        ...
        assert (
            AbstractCanTransportInterface.n_ar_measured.fget(self.mock_can_transport_interface)
    ...
    def test_n_bs_measured__get(self):
        ...
        assert (
            AbstractCanTransportInterface.n_bs_measured.fget(self.mock_can_transport_interface)
    ...
    def test_n_br_max__n_ar_not_measured(self, n_bs_timeout):
        ...
        assert AbstractCanTransportInterface.n_br_max.fget(self.mock_can_transport_interface) == 0.9 * n_bs_timeout
    ...
    def test_n_cs_max__n_as_not_measured(self, n_cr_timeout):
        ...
        assert AbstractCanTransportInterface.n_cs_max.fget(self.mock_can_transport_interface) == 0.9 * n_cr_timeout
    ...
    def test_n_cr_measured__get(self):
        ...
        assert (
            AbstractCanTransportInterface.n_cr_measured.fget(self.mock_can_transport_interface)
    ...
    @pytest.mark.parametrize("message_record", [Mock(), "not a message"])
    @patch(f"{SCRIPT_LOCATION}.isinstance")
    def test_update_n_bs_measured__type_error(self, mock_isinstance, message_record):
        mock_isinstance.return_value = False
        with pytest.raises(TypeError):
            AbstractCanTransportInterface._update_n_bs_measured(
                self.mock_can_transport_interface, message_record=message_record
            )
        mock_isinstance.assert_called_once_with(message_record, UdsMessageRecord)

    @pytest.mark.parametrize(
        "message_record", [Mock(direction=TransmissionDirection.RECEIVED), Mock(direction="not transmitted")]
    )
    @patch(f"{SCRIPT_LOCATION}.isinstance")
    ...
    def test_update_n_bs_measured__1_record(self):
        ...
        assert (
            AbstractCanTransportInterface._update_n_bs_measured(
                self.mock_can_transport_interface, message_record=mock_message_record
            )
            is None
        )
        assert self.mock_can_transport_interface._AbstractCanTransportInterface__n_bs_measured is None
    ...
    @pytest.mark.parametrize(
        "message_record, expected_n_bs_measurements",
        [
            (
                Mock(
                    spec=UdsMessageRecord,
                    ...
                    packets_records=(
                        Mock(
                            ...
                            transmission_native_timestamp=0.000,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.FLOW_CONTROL,
                            transmission_native_timestamp=0.001,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.CONSECUTIVE_FRAME,
                            transmission_native_timestamp=0.002,
                        ),
                    ),
                ),
                (1,),
                ...
                Mock(
                    ...
                    packets_records=(
                        ...
                        Mock(
                            ...
                            transmission_native_timestamp=1.1,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.FLOW_CONTROL,
                        ...
                        Mock(
                            ...
                            transmission_native_timestamp=2.2,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.FLOW_CONTROL,
                        ...
                        Mock(
                            ...
                            transmission_native_timestamp=2.98,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.CONSECUTIVE_FRAME,
    ...
    def test_update_n_cr_measured__type_error(self, mock_isinstance, message_record):
        mock_isinstance.return_value = False
        with pytest.raises(TypeError):
            AbstractCanTransportInterface._update_n_cr_measured(
                self.mock_can_transport_interface, message_record=message_record
            )
        mock_isinstance.assert_called_once_with(message_record, UdsMessageRecord)

    @pytest.mark.parametrize(
        "message_record", [Mock(direction=TransmissionDirection.TRANSMITTED), Mock(direction="not received")]
    )
    @patch(f"{SCRIPT_LOCATION}.isinstance")
    ...
    @pytest.mark.parametrize(
        "message, expected_n_cr_measurements",
        [
            (
                Mock(
                    spec=UdsMessageRecord,
                    ...
                    packets_records=(
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.FIRST_FRAME,
                            transmission_native_timestamp=0.1,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.FLOW_CONTROL,
                            transmission_native_timestamp=0.2,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.CONSECUTIVE_FRAME,
                            transmission_native_timestamp=0.4,
                        ),
                    ),
                ),
                (200,),
                ...
                Mock(
                    ...
                    packets_records=(
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.FIRST_FRAME,
                            transmission_native_timestamp=0.123456,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.FLOW_CONTROL,
                            transmission_native_timestamp=0.789012,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.FLOW_CONTROL,
                            transmission_native_timestamp=0.345678,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.CONSECUTIVE_FRAME,
                            transmission_native_timestamp=0.901234,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.FLOW_CONTROL,
                            transmission_native_timestamp=1.111111,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.CONSECUTIVE_FRAME,
                            transmission_native_timestamp=1.223344,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.CONSECUTIVE_FRAME,
                            transmission_native_timestamp=1.5566772,
                        ),
                    ),
                ),
                ...
                Mock(
                    ...
                    packets_records=(
                        ...
                        Mock(
                            ...
                            transmission_native_timestamp=12.34,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.FLOW_CONTROL,
                        ...
                        Mock(
                            ...
                            transmission_native_timestamp=65.78,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.FLOW_CONTROL,
                        ...
                        Mock(
                            ...
                            transmission_native_timestamp=90.12,
                        ),
                        Mock(
                            spec=CanPacketRecord,
                            packet_type=CanPacketType.CONSECUTIVE_FRAME,
    ...
    def test_update_n_cr_measured__multiple_records(self, message, expected_n_cr_measurements):
        assert (
            AbstractCanTransportInterface._update_n_cr_measured(
                self.mock_can_transport_interface, message_record=message
            )
            is None
        )
        assert (
    ...
    def test_send_cf_packets_block(self, packets, delay):
        ...
        mock_fc_transmission_timestamp = MagicMock(
            __add__=lambda this, other: this, __sub__=lambda this, other: this, __gt__=mock_fc_timestamp_gt
        )
        mock_cf_transmission_timestamp = MagicMock(
            __add__=lambda this, other: this, __sub__=lambda this, other: this, __gt__=mock_cf_timestamp_gt
        )
        packet_records = tuple(
            MagicMock(spec=CanPacketRecord, transmission_timestamp=mock_cf_transmission_timestamp) for _ in packets
        )
        self.mock_can_transport_interface.send_packet.side_effect = packet_records
        assert (
            AbstractCanTransportInterface._send_cf_packets_block(
                self.mock_can_transport_interface,
    ...
    async def test_async_send_cf_packets_block(self, packets, delay):
        ...
        assert (
            await AbstractCanTransportInterface._async_send_cf_packets_block(
                self.mock_can_transport_interface,
                cf_packets_block=packets,
                delay=delay,
                fc_transmission_timestamp=mock_fc_transmission_timestamp,
    ...
    @pytest.mark.parametrize(
        "sequence_number, block_size, remaining_data_length, timestamp_end",
        [
            (
                Mock(),
                Mock(),
                1,
                MagicMock(
                    __sub__=lambda this, other: this, __mul__=lambda this, other: this, __le__=Mock(return_value=False)
                ),
            ),
            (Mock(), Mock(), 987, None),
        ],
    )
    def test_receive_cf_packets_block__timeout__n_cr(
        self, sequence_number, block_size, remaining_data_length, timestamp_end
    ):
        ...
        self.mock_can_transport_interface.n_cr_timeout = MagicMock(
            __sub__=lambda this, other: this,
            __add__=lambda this, other: this,
            __mul__=lambda this, other: this,
        ...
        with pytest.raises(TimeoutError):
            AbstractCanTransportInterface._receive_cf_packets_block(
                self.mock_can_transport_interface,
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                1,
                MagicMock(
                    __sub__=lambda this, other: this, __mul__=lambda this, other: this, __le__=Mock(return_value=True)
                ),
            ),
            (
                Mock(),
    ...
    def test_receive_cf_packets_block__timeout__end(
        self, sequence_number, block_size, remaining_data_length, timestamp_end
    ):
    ...
    def test_receive_cf_packets_block__initial_packet(
        self, sequence_number, block_size, remaining_data_length, timestamp_end
    ):
        self.mock_perf_counter.return_value = self.mock_can_transport_interface.n_cr_timeout = MagicMock(
            __sub__=lambda this, other: this,
        ...
        self.mock_can_transport_interface._message_receive_start.assert_called_once_with(
            initial_packet=self.mock_can_transport_interface.receive_packet.return_value, timestamp_end=timestamp_end
        )
        self.mock_warn.assert_called_once()

    @pytest.mark.parametrize(
        "sequence_number, packet_sequence_numbers, block_size, remaining_data_length, timestamp_end",
        [
            (
                1,
                [0],
    ...
    def test_receive_cf_packets_block__incorrect_sn(
        self, sequence_number, packet_sequence_numbers, block_size, remaining_data_length, timestamp_end
    ):
        self.mock_perf_counter.return_value = self.mock_can_transport_interface.n_cr_timeout = MagicMock(
            __sub__=lambda this, other: this,
            __add__=lambda this, other: this,
    ...
    def test_receive_cf_packets_block__cf_block(
        self, sequence_number, block_size, remaining_data_length, timestamp_end
    ):
        self.mock_perf_counter.return_value = self.mock_can_transport_interface.n_cr_timeout = MagicMock(
            __sub__=lambda this, other: this,
        ...
        self.mock_can_transport_interface.receive_packet.side_effect = packet_sequence[:]
        assert AbstractCanTransportInterface._receive_cf_packets_block(
            self.mock_can_transport_interface,
            sequence_number=sequence_number,
            block_size=block_size,
            remaining_data_length=remaining_data_length,
    ...
    @pytest.mark.parametrize(
        "sequence_number, remaining_data_length, payload, timestamp_end",
        [
            (
                1,
                1,
    ...
    def test_receive_cf_packets_block__remaining_payload(
        self, sequence_number, remaining_data_length, payload, timestamp_end
    ):
        self.mock_perf_counter.return_value = self.mock_can_transport_interface.n_cr_timeout = MagicMock(
            __sub__=lambda this, other: this,
            __add__=lambda this, other: this,
    ...
    @pytest.mark.asyncio
    async def test_async_receive_cf_packets_block__timeout__n_cr(
        self, sequence_number, block_size, remaining_data_length, timestamp_end
    ):
        mock_loop = Mock()
        mock_is_n_cr_timeout_reached = Mock(side_effect=(False, True))
        ...
        self.mock_can_packet_type_is_initial_packet_type.return_value = False
        with pytest.raises(TimeoutError):
            await AbstractCanTransportInterface._async_receive_cf_packets_block(
                self.mock_can_transport_interface,
                sequence_number=sequence_number,
                block_size=block_size,
                remaining_data_length=remaining_data_length,
        ...
        self.mock_can_transport_interface.async_receive_packet.assert_called_once_with(
            timeout=self.mock_min.return_value, loop=mock_loop
        )
    ...
    @pytest.mark.asyncio
    async def test_async_receive_cf_packets_block__timeout__end(
        self, sequence_number, block_size, remaining_data_length, timestamp_end
    ):
        mock_loop = Mock()
        self.mock_perf_counter.return_value = self.mock_can_transport_interface.n_cr_timeout = MagicMock(
    ...
    @pytest.mark.asyncio
    async def test_async_receive_cf_packets_block__initial_packet(
        self, sequence_number, block_size, remaining_data_length, timestamp_end
    ):
        mock_loop = Mock()
        self.mock_perf_counter.return_value = self.mock_can_transport_interface.n_cr_timeout = MagicMock(
    ...
    @pytest.mark.asyncio
    async def test_async_receive_cf_packets_block__incorrect_sn(
        self, sequence_number, packet_sequence_numbers, block_size, remaining_data_length, timestamp_end
    ):
        mock_loop = Mock()
        self.mock_perf_counter.return_value = self.mock_can_transport_interface.n_cr_timeout = MagicMock(
    ...
    @pytest.mark.asyncio
    async def test_async_receive_cf_packets_block__cf_block(
        self, sequence_number, block_size, remaining_data_length, timestamp_end
    ):
        mock_loop = Mock()
        self.mock_perf_counter.return_value = self.mock_can_transport_interface.n_cr_timeout = MagicMock(
        ...
        self.mock_can_transport_interface.async_receive_packet.assert_has_calls(
            [call(timeout=self.mock_min.return_value, loop=mock_loop)] * block_size
        )
        self.mock_can_packet_type_is_initial_packet_type.assert_has_calls(
            [call(packet.packet_type) for packet in packet_sequence]
        )
    ...
    @pytest.mark.asyncio
    async def test_async_receive_cf_packets_block__remaining_payload(
        self, sequence_number, remaining_data_length, payload, timestamp_end
    ):
        mock_loop = Mock()
        self.mock_perf_counter.return_value = self.mock_can_transport_interface.n_cr_timeout = MagicMock(
        ...
        self.mock_can_transport_interface.async_receive_packet.assert_has_calls(
            [call(timeout=self.mock_min.return_value, loop=mock_loop)] * len(packet_sequence)
        )
        self.mock_can_packet_type_is_initial_packet_type.assert_has_calls(
            [call(packet.packet_type) for packet in packet_sequence]
        )
    ...
    def test_receive_consecutive_frames__timeout(self):
        ...
        mock_timestamp_end = MagicMock(
            __sub__=lambda this, other: this, __mul__=lambda this, other: this, __lt__=mock_is_timeout_reached
        )
        mock_first_frame = Mock(
            spec=CanPacketRecord,
            packet_type=CanPacketType.FIRST_FRAME,
            payload=[],
        ...
        with pytest.raises(TimeoutError):
            AbstractCanTransportInterface._receive_consecutive_frames(
                self.mock_can_transport_interface, first_frame=mock_first_frame, timestamp_end=mock_timestamp_end
            )
    ...
    def test_receive_consecutive_frames__new_message_interrupted(self, timestamp_end):
        ...
        self.mock_can_packet_type_is_initial_packet_type.return_value = True
        self.mock_can_transport_interface.n_br = MagicMock(
            __sub__=lambda this, other: this, __gt__=Mock(return_value=True)
        )
        assert (
            AbstractCanTransportInterface._receive_consecutive_frames(
                self=self.mock_can_transport_interface, first_frame=mock_first_frame, timestamp_end=timestamp_end
            )
            == self.mock_can_transport_interface._message_receive_start.return_value
        )
        self.mock_can_transport_interface._message_receive_start.assert_called_once_with(
    ...
    def test_receive_consecutive_frames__overflow(self, timestamp_end):
        ...
        self.mock_can_transport_interface.n_br = MagicMock(
            __sub__=lambda this, other: this, __gt__=Mock(return_value=False)
        )
    ...
    @patch(f"{SCRIPT_LOCATION}.isinstance")
    def test_receive_consecutive_frames__wait_then_receive_message(
        self, mock_isinstance, mock_uds_message_record, block_size, st_min, timestamp_end
    ):
        mock_isinstance.return_value = True
        mock_first_frame = Mock(
            spec=CanPacketRecord, packet_type=CanPacketType.FIRST_FRAME, payload=[], data_length=MagicMock()
        )
        self.mock_can_transport_interface.flow_control_parameters_generator = [
        ...
        assert (
            AbstractCanTransportInterface._receive_consecutive_frames(
                self.mock_can_transport_interface, first_frame=mock_first_frame, timestamp_end=timestamp_end
            )
        ...
        mock_isinstance.assert_called_once_with(
            self.mock_can_transport_interface._receive_cf_packets_block.return_value, mock_uds_message_record
        )
        self.mock_warn.assert_not_called()
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                8,
                [0x12, 0x34],
                [[Mock(spec=CanPacketRecord, payload=[0x56, 0x78, 0x90, 0xAB, 0xCD, 0xEF])]],
                [1],
                [6],
                None,
            ),
            (
                ...
                [
                    [
                        Mock(
                            spec=CanPacketRecord, payload=list(range(60, 67)), sequence_number=2 * i + j + (i % 3 == 0)
                        )
                        for j in range(1 + i)
                    ]
                    for i in range(4)
    ...
    @patch(f"{SCRIPT_LOCATION}.UdsMessageRecord")
    @patch(f"{SCRIPT_LOCATION}.isinstance")
    def test_receive_consecutive_frames__cf_received(
        self,
        mock_isinstance,
        ...
        cf_blocks,
        sequence_numbers,
        remaining_data_lengths,
        timestamp_end,
    ):
        mock_st_min = Mock()
        mock_first_frame = Mock(
            spec=CanPacketRecord, packet_type=CanPacketType.FIRST_FRAME, payload=ff_payload, data_length=data_length
        )
        mock_isinstance.return_value = False
        self.mock_can_packet_type_is_initial_packet_type.return_value = False
        self.mock_can_transport_interface.n_br = MagicMock(
    ...
    async def test_async_receive_consecutive_frames__timeout(self):
        ...
        with pytest.raises(TimeoutError):
            await AbstractCanTransportInterface._async_receive_consecutive_frames(
                self.mock_can_transport_interface,
    ...
    async def test_async_receive_consecutive_frames__new_message_interrupted(self, timestamp_end):
        ...
        assert (
            await AbstractCanTransportInterface._async_receive_consecutive_frames(
                self=self.mock_can_transport_interface,
                first_frame=mock_first_frame,
                timestamp_end=timestamp_end,
                loop=mock_loop,
            )
    ...
    async def test_async_receive_consecutive_frames__overflow(self, timestamp_end):
        ...
        self.mock_can_transport_interface.async_send_packet.assert_called_once_with(
            self.mock_can_transport_interface.segmenter.get_flow_control_packet.return_value, loop=mock_loop
        )
        self.mock_warn.assert_not_called()
    ...
    @patch(f"{SCRIPT_LOCATION}.isinstance")
    @pytest.mark.asyncio
    async def test_async_receive_consecutive_frames__wait_then_receive_message(
        self, mock_isinstance, mock_uds_message_record, block_size, st_min, timestamp_end
    ):
        mock_loop = Mock()
        mock_isinstance.return_value = True
        ...
        mock_isinstance.assert_called_once_with(
            self.mock_can_transport_interface._async_receive_cf_packets_block.return_value, mock_uds_message_record
        )
        self.mock_warn.assert_not_called()
    ...
    @patch(f"{SCRIPT_LOCATION}.isinstance")
    @pytest.mark.asyncio
    async def test_async_receive_consecutive_frames__cf_received(
        self,
        mock_isinstance,
        mock_uds_message_record,
        data_length,
    ...
    def test_message_receive_start__sf(self, mock_uds_message_record):
        ...
        assert (
            AbstractCanTransportInterface._message_receive_start(
                self.mock_can_transport_interface, initial_packet=mock_packet, timestamp_end=Mock()
            )
            == mock_uds_message_record.return_value
        )
    ...
    def test_message_receive_start__ff(self):
        ...
        assert (
            AbstractCanTransportInterface._message_receive_start(
                self.mock_can_transport_interface, initial_packet=mock_packet, timestamp_end=mock_timestamp_end
            )
        ...
        self.mock_can_transport_interface._receive_consecutive_frames.assert_called_once_with(
            first_frame=mock_packet, timestamp_end=mock_timestamp_end
        )
    ...
    async def test_async_message_receive_start__sf(self, mock_uds_message_record):
        mock_packet = Mock(spec=CanPacketRecord, packet_type=CanPacketType.SINGLE_FRAME)
        assert (
            await AbstractCanTransportInterface._async_message_receive_start(
                self.mock_can_transport_interface, initial_packet=mock_packet, timestamp_end=Mock(), loop=Mock()
            )
            == mock_uds_message_record.return_value
        )
        mock_uds_message_record.assert_called_once_with([mock_packet])
    ...
    async def test_async_message_receive_start__ff(self):
        ...
        self.mock_can_transport_interface._async_receive_consecutive_frames.assert_called_once_with(
            first_frame=mock_packet, timestamp_end=mock_timestamp_end, loop=mock_loop
        )
    ...
    @patch(f"{SCRIPT_LOCATION}.UdsMessageRecord")
    def test_send_message__single_frame(self, mock_uds_message_record, message):
        ...
        mock_uds_message_record.assert_called_once_with([self.mock_can_transport_interface.send_packet.return_value])
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (MagicMock(spec=UdsMessage, payload=[0x3E, 0x80], addressing_type=AddressingType.PHYSICAL), 0xFF),
        ],
    )
    @patch(f"{SCRIPT_LOCATION}.UdsMessageRecord")
    def test_send_message__multiple_packets__st_min__block_size_0(self, mock_uds_message_record, message, st_min):
        mock_segmented_message = [Mock(spec=CanPacket, packet_type=CanPacketType.FIRST_FRAME)]
        mock_segmented_message.extend(
            [Mock(spec=CanPacket, packet_type=CanPacketType.CONSECUTIVE_FRAME) for _ in range(randint(1, 20))]
        )
        self.mock_can_transport_interface.segmenter.segmentation.return_value = mock_segmented_message
        mock_add_ff_timestamp = Mock()
        self.mock_can_transport_interface.send_packet.return_value.transmission_timestamp = MagicMock(
            __add__=mock_add_ff_timestamp
        )
        self.mock_can_transport_interface.n_bs_timeout = MagicMock(__div__=Mock())
        self.mock_can_transport_interface.n_cs = None
        mock_flow_control_record = Mock(
            spec=CanPacketRecord,
            packet_type=CanPacketType.FLOW_CONTROL,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (Mock(spec=UdsMessage, payload=[0x3E, 0x80], addressing_type=AddressingType.PHYSICAL), 5, 0x00),
        ],
    )
    @patch(f"{SCRIPT_LOCATION}.UdsMessageRecord")
    def test_send_message__multiple_packets__n_cs__block_size_1(self, mock_uds_message_record, message, n_cs, st_min):
        mock_segmented_message = [Mock(spec=CanPacket, packet_type=CanPacketType.FIRST_FRAME)]
        mock_segmented_message.extend(
            [Mock(spec=CanPacket, packet_type=CanPacketType.CONSECUTIVE_FRAME) for _ in range(randint(1, 20))]
        )
        ...
        mock_sent_packet_record = Mock(
            spec=CanPacketRecord, transmission_timestamp=MagicMock(__add__=mock_add_cf_timestamp)
        )
        ...
        self.mock_can_transport_interface._wait_for_flow_control.assert_has_calls(
            ...
            + [call(timeout_timestamp=mock_add_cf_timestamp.return_value) for _ in mock_segmented_message[1:-1]],
            any_order=False,
        )
        self.mock_can_transport_interface._send_cf_packets_block.assert_has_calls(
            [
                call(
                    cf_packets_block=[packet],
                    delay=n_cs,
                    fc_transmission_timestamp=mock_flow_control_record.transmission_timestamp,
                )
    ...
    @patch(f"{SCRIPT_LOCATION}.UdsMessageRecord")
    def test_send_message__multiple_packets__wait(self, mock_uds_message_record, message):
        mock_segmented_message = [Mock(spec=CanPacket, packet_type=CanPacketType.FIRST_FRAME)]
        mock_segmented_message.extend(
            [Mock(spec=CanPacket, packet_type=CanPacketType.CONSECUTIVE_FRAME) for _ in range(randint(1, 20))]
        )
        ...
        mock_flow_control_record_wait = Mock(
            spec=CanPacketRecord,
            packet_type=CanPacketType.FLOW_CONTROL,
            flow_status=CanFlowStatus.Wait,
            transmission_timestamp=MagicMock(__add__=mock_add_fc_timestamp),
        )
        mock_flow_control_record_continue = Mock(
            spec=CanPacketRecord,
            packet_type=CanPacketType.FLOW_CONTROL,
            flow_status=CanFlowStatus.ContinueToSend,
            block_size=0,
        )
        self.mock_can_transport_interface._wait_for_flow_control.side_effect = [
    ...
    def test_send_message__multiple_packets__overflow(self, message):
        ...
        mock_flow_control_record_overflow = Mock(
            spec=CanPacketRecord, packet_type=CanPacketType.FLOW_CONTROL, flow_status=CanFlowStatus.Overflow
        )
    ...
    def test_send_message__multiple_packets__unknown_flow_status(self, message):
        ...
        mock_flow_control_record_unknown = Mock(
            spec=CanPacketRecord, packet_type=CanPacketType.FLOW_CONTROL, flow_status=Mock()
        )
    ...
    @patch(f"{SCRIPT_LOCATION}.UdsMessageRecord")
    @pytest.mark.asyncio
    async def test_async_send_message__single_frame(self, mock_uds_message_record, message):
        mock_segmented_message = [Mock(spec=CanPacket)]
        self.mock_can_transport_interface.segmenter.segmentation.return_value = mock_segmented_message
        assert (
        ...
        self.mock_can_transport_interface.setup_async.assert_called_once_with(self.mock_get_running_loop.return_value)
        self.mock_can_transport_interface.clear_flow_control_frame_buffers.assert_called_once_with()
        self.mock_can_transport_interface.segmenter.segmentation.assert_called_once_with(message)
        self.mock_can_transport_interface.async_send_packet.assert_called_once_with(
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (Mock(spec=UdsMessage, payload=[0x3E, 0x80], addressing_type=AddressingType.PHYSICAL), 0xFF),
        ],
    )
    @patch(f"{SCRIPT_LOCATION}.UdsMessageRecord")
    @pytest.mark.asyncio
    async def test_async_send_message__multiple_packets__st_min__block_size_0(
        self, mock_uds_message_record, message, st_min
    ):
        ...
        self.mock_can_transport_interface.segmenter.segmentation.return_value = mock_segmented_message
        mock_add_ff_timestamp = Mock()
        self.mock_can_transport_interface.async_send_packet.return_value.transmission_timestamp = MagicMock(
            __add__=mock_add_ff_timestamp
        )
        self.mock_can_transport_interface.n_bs_timeout = MagicMock(__div__=Mock())
        self.mock_can_transport_interface.n_cs = None
        ...
        assert (
            await AbstractCanTransportInterface.async_send_message(
                self.mock_can_transport_interface, message=message, loop=mock_loop
            )
            == mock_uds_message_record.return_value
        )
        self.mock_can_transport_interface.setup_async.assert_called_once_with(mock_loop)
        self.mock_can_transport_interface.clear_flow_control_frame_buffers.assert_called_once_with()
        self.mock_can_transport_interface.segmenter.segmentation.assert_called_once_with(message)
    ...
    @patch(f"{SCRIPT_LOCATION}.UdsMessageRecord")
    @pytest.mark.asyncio
    async def test_async_send_message__multiple_packets__n_cs__block_size_1(
        self, mock_uds_message_record, message, n_cs, st_min
    ):
        mock_segmented_message = [Mock(spec=CanPacket, packet_type=CanPacketType.FIRST_FRAME)]
        mock_segmented_message.extend(
            [Mock(spec=CanPacket, packet_type=CanPacketType.CONSECUTIVE_FRAME) for _ in range(randint(1, 20))]
    ...
    @patch(f"{SCRIPT_LOCATION}.UdsMessageRecord")
    @pytest.mark.asyncio
    async def test_async_send_message__multiple_packets__wait(self, mock_uds_message_record, message):
        mock_segmented_message = [Mock(spec=CanPacket, packet_type=CanPacketType.FIRST_FRAME)]
        mock_segmented_message.extend(
            [Mock(spec=CanPacket, packet_type=CanPacketType.CONSECUTIVE_FRAME) for _ in range(randint(1, 20))]
        )
    ...
    def test_receive_message__timeout_error__no_time(self, start_timeout):
        ...
        with pytest.raises(MessageTransmissionNotStartedError):
            AbstractCanTransportInterface.receive_message(
                self.mock_can_transport_interface, start_timeout=start_timeout
            )
        self.mock_validate_timeout.assert_has_calls([call(start_timeout), call(None)])
    ...
    def test_receive_message__initial_packet(self, start_timeout, end_timeout):
        ...
        assert (
            AbstractCanTransportInterface.receive_message(
                self.mock_can_transport_interface, start_timeout=start_timeout, end_timeout=end_timeout
            )
            == self.mock_can_transport_interface._message_receive_start.return_value
        )
        self.mock_validate_timeout.assert_has_calls([call(start_timeout), call(end_timeout)])
        self.mock_can_transport_interface._message_receive_start.assert_called_once_with(
    ...
    def test_receive_message__cf_then_initial_packet(self, start_timeout, end_timeout):
        ...
        self.mock_can_transport_interface.receive_packet.assert_has_calls(
            calls=[
                call(
                    timeout=None
                    if start_timeout is None and end_timeout is None
                    else self.mock_perf_counter.return_value
                ),
                call(
                    timeout=None
                    if start_timeout is None and end_timeout is None
    ...
    async def test_async_receive_message__timeout_error__no_time(self, start_timeout):
        ...
        with pytest.raises(MessageTransmissionNotStartedError):
            await AbstractCanTransportInterface.async_receive_message(
                self.mock_can_transport_interface, start_timeout=start_timeout, loop=mock_loop
            )
        self.mock_validate_timeout.assert_has_calls([call(start_timeout), call(None)])
        mock_is_timeout_reached.assert_called_once()
        self.mock_can_transport_interface.setup_async.assert_called_once_with(loop=mock_loop)
        self.mock_can_transport_interface.async_receive_packet.assert_not_called()
        self.mock_can_transport_interface._update_n_cr_measured.assert_not_called()
    ...
    async def test_async_receive_message__initial_packet(self, start_timeout, end_timeout):
        ...
        assert (
            await AbstractCanTransportInterface.async_receive_message(
                self.mock_can_transport_interface, start_timeout=start_timeout, end_timeout=end_timeout, loop=mock_loop
            )
            == self.mock_can_transport_interface._async_message_receive_start.return_value
        )
        self.mock_validate_timeout.assert_has_calls([call(start_timeout), call(end_timeout)])
    ...
    async def test_async_receive_message__cf_then_initial_packet(self, start_timeout, end_timeout):
        ...
        assert (
            await AbstractCanTransportInterface.async_receive_message(
                self.mock_can_transport_interface, start_timeout=start_timeout, end_timeout=end_timeout, loop=None
            )
            == self.mock_can_transport_interface._async_message_receive_start.return_value
        )
        self.mock_validate_timeout.assert_has_calls([call(start_timeout), call(end_timeout)])
...
class TestAbstractCanTransportInterfacePerformance:
    ...
    def test_receive_message__start_timeout(
        self, mock_is_initial_packet_type, performance_tolerance_ms, mean_performance_tolerance_ms, start_timeout
    ):
        ...
        for _ in range(self.REPETITIONS):
            ...
            execution_time_ms = (timestamp_after - timestamp_before) * 1000.0
            execution_times.append(execution_time_ms)
            assert start_timeout <= execution_time_ms <= start_timeout + performance_tolerance_ms

        mean_execution_time_ms = sum(execution_times) / len(execution_times)
        assert start_timeout <= mean_execution_time_ms <= start_timeout + mean_performance_tolerance_ms
    ...
    @patch(f"{SCRIPT_LOCATION}.CanPacketType.is_initial_packet_type")
    @pytest.mark.asyncio
    async def test_async_receive_message__start_timeout(
        self, mock_is_initial_packet_type, performance_tolerance_ms, mean_performance_tolerance_ms, start_timeout
    ):
