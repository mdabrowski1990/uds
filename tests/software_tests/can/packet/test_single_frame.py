...
class TestCanSingleFrame:
    ...
    def setup_method(self):
        ...
        self._patcher_can_dlc_handler = patch(
            f"{SCRIPT_LOCATION}.CanDlcHandler", Mock(MIN_BASE_UDS_DLC=CanDlcHandler.MIN_BASE_UDS_DLC)
        )
    ...
    @pytest.mark.parametrize(
        "addressing_format, raw_frame_data, ai_data_bytes_number, expected_output",
        [
    ...
    @pytest.mark.parametrize(
        "addressing_format, raw_frame_data, sf_dl_data_bytes, dlc, min_dlc",
        [
    ...
    def test_validate_single_frame_data__valid__no_warning(
        self,
        mock_is_single_frame,
        mock_extract_sf_dl_data_bytes,
        ...
        assert validate_single_frame_data(addressing_format=addressing_format, raw_frame_data=raw_frame_data) is None
        self.mock_validate_raw_bytes.assert_called_once_with(raw_frame_data, allow_empty=False)
        mock_is_single_frame.assert_called_once_with(addressing_format=addressing_format, raw_frame_data=raw_frame_data)
        mock_extract_sf_dl_data_bytes.assert_called_once_with(
    ...
    @patch(f"{SCRIPT_LOCATION}.extract_sf_dl_data_bytes")
    @patch(f"{SCRIPT_LOCATION}.is_single_frame")
    def test_validate_single_frame_data__valid__warning(
        self,
        mock_is_single_frame,
        mock_extract_sf_dl_data_bytes,
        mock_get_single_frame_min_dlc,
    ...
    @patch(f"{SCRIPT_LOCATION}.extract_sf_dl_data_bytes")
    @patch(f"{SCRIPT_LOCATION}.is_single_frame")
    def test_validate_single_frame_data__value_error(
        self,
        mock_is_single_frame,
        mock_extract_sf_dl_data_bytes,
        mock_get_single_frame_min_dlc,
        ...
        with pytest.raises(ValueError):
            validate_single_frame_data(addressing_format=addressing_format, raw_frame_data=raw_frame_data)
        self.mock_validate_raw_bytes.assert_called_once_with(raw_frame_data, allow_empty=False)
        mock_is_single_frame.assert_called_once_with(addressing_format=addressing_format, raw_frame_data=raw_frame_data)
    ...
    @patch(f"{SCRIPT_LOCATION}.extract_sf_dl_data_bytes")
    @patch(f"{SCRIPT_LOCATION}.is_single_frame")
    def test_validate_single_frame_data__inconsistent(
        self,
        mock_is_single_frame,
        mock_extract_sf_dl_data_bytes,
        mock_get_single_frame_min_dlc,
    ...
    @pytest.mark.parametrize(
        "addressing_format, payload, ai_data_bytes, data_bytes_number, sf_dl_bytes",
        [
    ...
    @patch(f"{SCRIPT_LOCATION}.get_single_frame_min_dlc")
    def test_create_single_frame_data__mandatory_args(
        self,
        mock_get_single_frame_min_dlc,
        mock_encode_sf_dl,
        addressing_format,
        ...
        assert create_single_frame_data(addressing_format=addressing_format, payload=payload) == expected_output
        mock_get_single_frame_min_dlc.assert_called_once_with(
            addressing_format=addressing_format, payload_length=len(payload)
        )
        mock_encode_sf_dl.assert_called_once_with(
            sf_dl=len(payload), dlc=mock_get_single_frame_min_dlc.return_value, addressing_format=addressing_format
        )
        ...
        self.mock_can_addressing_information.encode_ai_data_bytes.assert_called_once_with(
            addressing_format=addressing_format, target_address=None, address_extension=None
        )
    ...
    @pytest.mark.parametrize(
        "addressing_format, payload, dlc, filler_byte, target_address, address_extension, "
    ...
    @patch(f"{SCRIPT_LOCATION}.encode_sf_dl")
    @patch(f"{SCRIPT_LOCATION}.get_single_frame_min_dlc")
    def test_create_single_frame_data__all_args(
        self,
        mock_get_single_frame_min_dlc,
        mock_encode_sf_dl,
        addressing_format,
        ...
        mock_get_single_frame_min_dlc.assert_not_called()
        mock_encode_sf_dl.assert_called_once_with(sf_dl=len(payload), dlc=dlc, addressing_format=addressing_format)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                Mock(),
                [0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC, 0xDE, 0xF0, 0xFF],
                Mock(),
                0xA5,
                Mock(),
                Mock(),
    ...
    @patch(f"{SCRIPT_LOCATION}.encode_sf_dl")
    @patch(f"{SCRIPT_LOCATION}.get_single_frame_min_dlc")
    def test_create_single_frame_data__inconsistent(
        self,
        mock_get_single_frame_min_dlc,
        mock_encode_sf_dl,
        addressing_format,
    ...
    def test_generate_single_frame_data__mandatory_args(
        self,
        mock_generate_sf_dl_bytes,
        addressing_format,
        payload,
        dlc,
        sf_dl_short,
        ...
        assert (
            generate_single_frame_data(
                addressing_format=addressing_format, payload=payload, dlc=dlc, sf_dl_short=sf_dl_short
            )
            == expected_output
        )
    ...
    @patch(f"{SCRIPT_LOCATION}.generate_sf_dl_bytes")
    def test_generate_single_frame_data__all_args(
        self,
        mock_generate_sf_dl_bytes,
        addressing_format,
        payload,
    ...
    @patch(f"{SCRIPT_LOCATION}.generate_sf_dl_bytes")
    def test_generate_single_frame_data__inconsistent(
        self,
        mock_generate_sf_dl_bytes,
        addressing_format,
        payload,
    ...
    @pytest.mark.parametrize(
        "addressing_format, raw_frame_data, ai_data_bytes_number, sf_dl_bytes_number, sf_dl",
        [
    ...
    def test_extract_single_frame_payload(
        self,
        mock_extract_sf_dl,
        mock_get_sf_dl_bytes_number,
        addressing_format,
        raw_frame_data,
        ...
        self.mock_can_addressing_information.get_ai_data_bytes_number.return_value = ai_data_bytes_number
        assert (
            extract_single_frame_payload(addressing_format=addressing_format, raw_frame_data=raw_frame_data)
    ...
    @patch(f"{SCRIPT_LOCATION}.extract_sf_dl_data_bytes")
    def test_extract_sf_dl__valid(
        self, mock_extract_sf_dl_data_bytes, addressing_format, raw_frame_data, sf_dl_data_bytes, sf_dl
    ):
        mock_extract_sf_dl_data_bytes.return_value = sf_dl_data_bytes
    ...
    @patch(f"{SCRIPT_LOCATION}.extract_sf_dl_data_bytes")
    def test_extract_sf_dl__not_implemented(
        self, mock_extract_sf_dl_data_bytes, addressing_format, raw_frame_data, sf_dl_data_bytes
    ):
        mock_extract_sf_dl_data_bytes.return_value = sf_dl_data_bytes
    ...
    @patch(f"{SCRIPT_LOCATION}.get_sf_dl_bytes_number")
    def test_get_max_sf_dl__with_dlc(
        self,
        mock_get_sf_dl_bytes_number,
        addressing_format,
        dlc,
    ...
    @patch(f"{SCRIPT_LOCATION}.get_sf_dl_bytes_number")
    def test_get_max_sf_dl__without_dlc(
        self, mock_get_sf_dl_bytes_number, addressing_format, frame_data_bytes_number, ai_data_bytes_number
    ):
        self.mock_can_dlc_handler.MAX_DATA_BYTES_NUMBER = frame_data_bytes_number
        self.mock_can_addressing_information.get_ai_data_bytes_number.return_value = ai_data_bytes_number
        assert (
            get_max_sf_dl(addressing_format=addressing_format)
    ...
    @patch(f"{SCRIPT_LOCATION}.get_sf_dl_bytes_number")
    def test_get_max_sf_dl__too_short(
        self,
        mock_get_sf_dl_bytes_number,
        addressing_format,
        dlc,
    ...
    def test_get_single_frame_min_dlc__short_dlc(self, addressing_format, payload_length, ai_data_bytes, decoded_dlc):
        ...
        assert (
            get_single_frame_min_dlc(addressing_format=addressing_format, payload_length=payload_length)
    ...
    def test_get_single_frame_min_dlc__long_dlc(self, addressing_format, payload_length, ai_data_bytes, decoded_dlc):
        ...
        self.mock_can_dlc_handler.get_min_dlc.assert_has_calls(
            [call(data_bytes_number_1), call(data_bytes_number_2)], any_order=False
        )
    ...
    @patch(f"{SCRIPT_LOCATION}.get_sf_dl_bytes_number")
    def test_extract_sf_dl_data_bytes(
        self, mock_get_sf_dl_bytes_number, addressing_format, raw_frame_data, sf_dl_bytes_number, ai_data_bytes_number
    ):
        mock_get_sf_dl_bytes_number.return_value = sf_dl_bytes_number
        self.mock_can_addressing_information.get_ai_data_bytes_number.return_value = ai_data_bytes_number
        assert (
            extract_sf_dl_data_bytes(addressing_format=addressing_format, raw_frame_data=raw_frame_data)
    ...
    @pytest.mark.parametrize(
        "dlc, expected_sf_dl_bytes_number",
        [
    ...
    def test_encode_sf_dl__short(self, mock_validate_sf_dl, mock_generate_sf_dl_bytes, sf_dl, dlc, addressing_format):
        assert (
            encode_sf_dl(sf_dl=sf_dl, dlc=dlc, addressing_format=addressing_format)
    ...
    @patch(f"{SCRIPT_LOCATION}.generate_sf_dl_bytes")
    @patch(f"{SCRIPT_LOCATION}.validate_sf_dl")
    def test_encode_sf_dl__long(self, mock_validate_sf_dl, mock_generate_sf_dl_bytes, sf_dl, dlc, addressing_format):
        assert (
            encode_sf_dl(sf_dl=sf_dl, dlc=dlc, addressing_format=addressing_format)
            == mock_generate_sf_dl_bytes.return_value
        )
    ...
    @pytest.mark.parametrize(
        "sf_dl_short, sf_dl_long, expected_output",
        [
    ...
    def test_validate_sf_dl__inconsistent(self, mock_get_max_sf_dl, sf_dl, max_sf, dlc, addressing_format):
    ...
    @patch(f"{SCRIPT_LOCATION}.get_max_sf_dl")
    def test_validate_sf_dl__valid(self, mock_get_max_sf_dl, sf_dl, max_sf, dlc, addressing_format):
        mock_get_max_sf_dl.return_value = max_sf
...
class TestCanSingleFrameIntegration:
    ...
    @pytest.mark.parametrize(
        "kwargs, expected_raw_frame_data",
        [
            ({"addressing_format": CanAddressingFormat.NORMAL_ADDRESSING, "payload": [0x3E]}, bytearray([0x01, 0x3E])),
            (
                {
                ...
                bytearray([0x01, 0x3E] + ([DEFAULT_FILLER_BYTE] * 6)),
            ),
            (
                {
                ...
                bytearray([0xF2, 0x00, 0x36, *range(54)] + ([0x66] * 7)),
            ),
            (
                {
                ...
                bytearray([0x12, 0x06, 0x9A, 0xB8, 0xC4, 0x67, 0x10, 0x00]),
            ),
            (
                {
                ...
                bytearray([0x12, 0x00, 0x07, 0x9A, 0xB8, 0xC4, 0x67, 0x10, 0x00, 0x01, 0x99, 0x99]),
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        "kwargs",
        [
            {"addressing_format": CanAddressingFormat.NORMAL_ADDRESSING, "payload": b"\x3e", "dlc": 1},
            {"addressing_format": CanAddressingFormat.NORMAL_FIXED_ADDRESSING, "payload": bytes(range(63))},
            {
                "addressing_format": CanAddressingFormat.EXTENDED_ADDRESSING,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                bytearray([0x00, 0xAB, 0x3E] + ([DEFAULT_FILLER_BYTE] * 5)),
            ),
            (
                {
                    "addressing_format": CanAddressingFormat.EXTENDED_ADDRESSING,
            ...
            (
                ...
                bytearray([0x12, 0x05, 0x9A, 0xB8, 0xC4, 0x67, 0x10, 0x00]),
            ),
            (
                {
                    "addressing_format": CanAddressingFormat.MIXED_29BIT_ADDRESSING,
                ...
                bytearray([0x12, 0x02, 0x9A, 0xB8, 0x99, 0x99, 0x99]),
            ),
        ],
    )
    ...
    def test_extract_sf_dl(self, addressing_format, raw_frame_data, expected_sf_dl):
        assert extract_sf_dl(addressing_format=addressing_format, raw_frame_data=raw_frame_data) == expected_sf_dl
