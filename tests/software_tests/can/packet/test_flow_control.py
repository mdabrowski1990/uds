...
class TestCanSTmin:
    ...
    @pytest.mark.parametrize(
        "value", [CanSTminTranslator.MAX_VALUE_MS_RANGE + 1, -1, CanSTminTranslator.MIN_TIME_VALUE_100US_RANGE * 1.5]
    )
    ...
    def test_is_time_value__valid(self, mock_is_100us_value, mock_is_ms_value, value, is_ms_value, is_100us_value):
    ...
    @pytest.mark.parametrize(
        "value", [CanSTminTranslator.MIN_VALUE_MS_RANGE, 59.0, CanSTminTranslator.MAX_VALUE_MS_RANGE]
    )
    ...
    @pytest.mark.parametrize(
        "value", [CanSTminTranslator.MIN_TIME_VALUE_100US_RANGE, 0.5, CanSTminTranslator.MAX_TIME_VALUE_100US_RANGE]
    )
...
class TestCanFlowControl:
    ...
    def test_is_flow_control(self, addressing_format, raw_frame_data, ai_data_bytes_number, expected_output):
    ...
    @pytest.mark.parametrize(
        "addressing_format, raw_frame_data, min_dlc, dlc",
        [
            (Mock(), MagicMock(), 5, 5),
    ...
    def test_validate_frame_data__valid(
        self,
        mock_is_flow_control,
        mock_get_flow_control_min_dlc,
        ...
        mock_extract_flow_status.assert_called_once_with(
    ...
    @patch(f"{SCRIPT_LOCATION}.get_flow_control_min_dlc")
    @patch(f"{SCRIPT_LOCATION}.is_flow_control")
    def test_validate_frame_data__inconsistent(
        self,
        mock_is_flow_control,
        mock_get_flow_control_min_dlc,
        mock_extract_flow_status,
    ...
    @patch(f"{SCRIPT_LOCATION}.get_flow_control_min_dlc")
    @patch(f"{SCRIPT_LOCATION}.is_flow_control")
    def test_validate_frame_data__value_error(
        self,
        mock_is_flow_control,
        mock_get_flow_control_min_dlc,
        mock_extract_flow_status,
    ...
    @pytest.mark.parametrize(
        "addressing_format, flow_status, ai_data_bytes, fs_data_bytes",
        [
    ...
    def test_create_flow_control_data__mandatory_args(
        self,
        mock_encode_flow_status,
        mock_get_flow_control_min_dlc,
        addressing_format,
        flow_status,
        ai_data_bytes,
        ...
        assert create_flow_control_data(addressing_format=addressing_format, flow_status=flow_status) == expected_output
    ...
    @pytest.mark.parametrize(
        "addressing_format, flow_status, block_size, st_min, dlc, filler_byte, target_address, "
        ...
        [
            (
                ...
                0x00,
                0xFF,
                CanDlcHandler.MIN_BASE_UDS_DLC,
                0xA5,
                Mock(),
                Mock(),
                bytearray([0xA1]),
            ...
            (
                ...
                CanFlowStatus.ContinueToSend,
                0xFF,
                0x12,
                CanDlcHandler.MAX_DLC_VALUE,
                0x00,
                0xE5,
                0xD4,
                bytearray(),
    ...
    @patch(f"{SCRIPT_LOCATION}.get_flow_control_min_dlc")
    @patch(f"{SCRIPT_LOCATION}.encode_flow_status")
    def test_create_flow_control_data__all_args(
        self,
        mock_encode_flow_status,
        mock_get_flow_control_min_dlc,
        addressing_format,
        ...
        self.mock_validate_raw_byte.assert_has_calls(
            [call(filler_byte), call(block_size), call(st_min)], any_order=True
        )
        self.mock_can_addressing_information.encode_ai_data_bytes.assert_called_once_with(
    ...
    @patch(f"{SCRIPT_LOCATION}.get_flow_control_min_dlc")
    @patch(f"{SCRIPT_LOCATION}.encode_flow_status")
    def test_create_flow_control_data__inconsistent(
        self,
        mock_encode_flow_status,
        mock_get_flow_control_min_dlc,
        addressing_format,
    ...
    @pytest.mark.parametrize(
        "addressing_format, flow_status, dlc, ai_data_bytes, fs_data_bytes, data_bytes_number",
        [
    ...
    def test_generate_flow_control_data__mandatory_args(
        self,
        mock_generate_flow_status,
        addressing_format,
        flow_status,
        dlc,
        ai_data_bytes,
        ...
        assert (
            generate_flow_control_data(addressing_format=addressing_format, flow_status=flow_status, dlc=dlc)
            == expected_output
        )
        self.mock_validate_raw_byte.assert_called_once_with(DEFAULT_FILLER_BYTE)
        self.mock_can_addressing_information.encode_ai_data_bytes.assert_called_once_with(
    ...
    @pytest.mark.parametrize(
        "addressing_format, flow_status, dlc, block_size, st_min, filler_byte, target_address, "
        "address_extension, ai_data_bytes, fs_data_bytes, data_bytes_number",
        [
    ...
    @patch(f"{SCRIPT_LOCATION}.generate_flow_status")
    def test_generate_flow_control_data__all_args(
        self,
        mock_generate_flow_status,
        addressing_format,
        flow_status,
    ...
    @patch(f"{SCRIPT_LOCATION}.generate_flow_status")
    def test_generate_flow_control_data__inconsistent(
        self,
        mock_generate_flow_status,
        addressing_format,
        flow_status,
    ...
    @pytest.mark.parametrize(
        "addressing_format, raw_frame_data, ai_data_bytes_number",
        [
            (Mock(), [0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC, 0xDE, 0xF0], 0),
            (
                CanAddressingFormat.EXTENDED_ADDRESSING,
                bytearray([0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC, 0xDE, 0xF0][::-1]),
                1,
            ),
        ],
    )
    def test_extract_flow_status(self, addressing_format, raw_frame_data, ai_data_bytes_number):
        ...
        assert (
            ...
            == self.mock_can_flow_status.return_value
        )
    ...
    def test_extract_block_size(self, addressing_format, raw_frame_data, ai_data_bytes_number):
        self.mock_can_addressing_information.get_ai_data_bytes_number.return_value = ai_data_bytes_number
        assert (
            extract_block_size(addressing_format=addressing_format, raw_frame_data=raw_frame_data)
    ...
    def test_extract_st_min(self, addressing_format, raw_frame_data, ai_data_bytes_number):
        self.mock_can_addressing_information.get_ai_data_bytes_number.return_value = ai_data_bytes_number
        assert (
            extract_st_min(addressing_format=addressing_format, raw_frame_data=raw_frame_data)
    ...
    @pytest.mark.parametrize(
        "addressing_format, ai_data_bytes_number",
        [
            (Mock(), 0),
...
class TestCanFlowControlIntegration:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                {"addressing_format": CanAddressingFormat.NORMAL_ADDRESSING, "flow_status": CanFlowStatus.Overflow},
                bytearray([0x32, DEFAULT_FILLER_BYTE, DEFAULT_FILLER_BYTE]),
            ),
            (
                {
                ...
                bytearray([0x30, 0x00, 0xFF] + ([0x9B] * 61)),
            ),
            (
                {
                ...
                bytearray([0xA1, 0x30, 0xFF, 0x00, 0x85, 0x85, 0x85, 0x85]),
            ),
            (
                {
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            {"addressing_format": CanAddressingFormat.NORMAL_FIXED_ADDRESSING, "flow_status": 4},
            {
                "addressing_format": CanAddressingFormat.EXTENDED_ADDRESSING,
                "flow_status": CanFlowStatus.ContinueToSend,
                "block_size": 0xFF,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                bytearray([0xA1, 0x31, 0xFF, 0x00, 0x85, 0x85, 0x85, 0x85]),
            ),
            (
                {
                    "addressing_format": CanAddressingFormat.MIXED_11BIT_ADDRESSING,
    ...
    @pytest.mark.parametrize(
        "kwargs",
        [
            {"addressing_format": CanAddressingFormat.NORMAL_ADDRESSING, "flow_status": 0x10, "dlc": 3},
            {
                "addressing_format": CanAddressingFormat.NORMAL_FIXED_ADDRESSING,
                "flow_status": CanFlowStatus.Overflow,
                "dlc": 0,
...
class TestAbstractFlowControlParametersGenerator:
    ...
    def test_iter(self):
        assert (
            AbstractFlowControlParametersGenerator.__iter__(self.mock_flow_control_parameters_generator)
...
class TestDefaultFlowControlParametersGenerator:
    ...
    @pytest.mark.parametrize(
        "block_size, st_min, wait_count, repeat_wait", [(0, 0, 0, False), (0xFF, 0xFF, 1234, True)]
    )
    def test_init(self, block_size, st_min, wait_count, repeat_wait):
        DefaultFlowControlParametersGenerator.__init__(
            self.mock_flow_control_parameters_generator, block_size, st_min, wait_count, repeat_wait
        )
    ...
    @pytest.mark.parametrize("block_size, st_min", [(0, 0x55), (0xAA, 0x12)])
    ...
    @pytest.mark.parametrize("block_size, st_min, wait_count", [(0, 0x55, 1), (0xAA, 0x12, 54)])
    ...
    def test_block_size__get(self):
        ...
        assert (
            DefaultFlowControlParametersGenerator.block_size.fget(self.mock_flow_control_parameters_generator)
    ...
    def test_st_min__get(self):
        ...
        assert (
            DefaultFlowControlParametersGenerator.st_min.fget(self.mock_flow_control_parameters_generator)
    ...
    def test_wait_count__get(self):
        ...
        assert (
            DefaultFlowControlParametersGenerator.wait_count.fget(self.mock_flow_control_parameters_generator)
    ...
    def test_wait_count__set__value_error(self, mock_isinstance):
        ...
        with pytest.raises(ValueError):
            DefaultFlowControlParametersGenerator.wait_count.fset(
                self.mock_flow_control_parameters_generator, mock_value
            )
    ...
    def test_wait_count__set__valid(self, mock_isinstance):
        ...
        assert (
            self.mock_flow_control_parameters_generator._DefaultFlowControlParametersGenerator__wait_count == mock_value
        )
        mock_isinstance.assert_called_once_with(mock_value, int)
        mock_lt.assert_called_once_with(0)
    ...
    def test_repeat_wait__get(self):
        ...
        assert (
            DefaultFlowControlParametersGenerator.repeat_wait.fget(self.mock_flow_control_parameters_generator)
...
class TestDefaultFlowControlParametersGeneratorIntegration:
    ...
    @pytest.mark.parametrize(
        "init_params, following_fc_params",
        [
            (
                {},
                [
