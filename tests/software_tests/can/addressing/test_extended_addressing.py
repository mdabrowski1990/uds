...
class TestExtendedCanAddressingInformation:
    ...
    def test_validate_node_ai__valid(
        ...
        self.mock_addressing_information.tx_functional_params = tx_functional_params
        assert (
            ExtendedCanAddressingInformation._validate_addressing_information(self.mock_addressing_information) is None
        )
    ...
    def test_validate_addressing_params__value_error(self, addressing_format):
        with pytest.raises(ValueError):
            ExtendedCanAddressingInformation.validate_addressing_params(
    ...
    def test_validate_addressing_params__unused_args(self, unsupported_args):
        with pytest.raises(UnusedArgumentError):
            ExtendedCanAddressingInformation.validate_addressing_params(
                addressing_type=Mock(), can_id=Mock(), target_address=Mock(), **unsupported_args
            )
    ...
    def test_validate_addressing_params__valid(
        self, mock_is_compatible_can_id, addressing_type, can_id, target_address
    ):
        mock_is_compatible_can_id.return_value = True
        assert ExtendedCanAddressingInformation.validate_addressing_params(
            addressing_type=addressing_type, can_id=can_id, target_address=target_address
        ) == {
    ...
    def test_is_compatible_can_id(self, can_id, addressing_type):
        assert (
            ExtendedCanAddressingInformation.is_compatible_can_id(can_id, addressing_type)
