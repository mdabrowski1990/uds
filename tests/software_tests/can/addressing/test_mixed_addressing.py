...
class TestMixed11BitCanAddressingInformation:
    ...
    def test_decode_can_id(self, can_id):
        assert Mixed11BitCanAddressingInformation.decode_can_id(can_id) == {
    ...
    def test_validate_node_ai__valid(self, rx_physical_params, tx_physical_params,
        ...
        self.mock_addressing_information.rx_functional_params = rx_functional_params
        self.mock_addressing_information.tx_functional_params = tx_functional_params
        assert Mixed11BitCanAddressingInformation._validate_addressing_information(self.mock_addressing_information) is None
...
class TestMixed29BitCanAddressingInformation:
    ...
    def test_decode_can_id__not_implemented(self, mock_validate_can_id, mock_is_compatible_can_id, can_id):
        ...
        with pytest.raises(NotImplementedError):
            Mixed29BitCanAddressingInformation.decode_can_id(can_id=can_id)
    ...
    def test_decode_can_id__valid(self, addressing_type, target_address, source_address, priority, can_id):
        assert Mixed29BitCanAddressingInformation.decode_can_id(can_id=can_id) == {
    ...
    @patch(f"{SCRIPT_LOCATION}.Mixed29BitCanAddressingInformation.decode_can_id")
