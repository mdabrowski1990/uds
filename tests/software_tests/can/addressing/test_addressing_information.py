...
class TestCanAddressingInformation:
    ...
    @pytest.mark.parametrize(
        "addressing_format, rx_physical_params, tx_physical_params, rx_functional_params, tx_functional_params",
        [
    ...
    def test_new(
        self, addressing_format, rx_physical_params, tx_physical_params, rx_functional_params, tx_functional_params
    ):
        ...
        assert (
            CanAddressingInformation.__new__(
                cls=mock_cls,
            ...
            == mock_returned_class.return_value
        )
        mock_getitem.assert_called_once_with(addressing_format)
        mock_returned_class.assert_called_once_with(
            rx_physical_params=rx_physical_params,
            tx_physical_params=tx_physical_params,
            rx_functional_params=rx_functional_params,
            tx_functional_params=tx_functional_params,
    ...
    def test_get_ai_data_bytes_number(self, mock_ai_mapping, addressing_format):
        assert (
            CanAddressingInformation.get_ai_data_bytes_number(addressing_format=addressing_format)
    ...
    def test_validate_ai_data_bytes__valid(self, mock_get_ai_data_bytes_number, addressing_format, ai_data_bytes):
        ...
        assert (
            CanAddressingInformation.validate_ai_data_bytes(
                addressing_format=addressing_format, ai_data_bytes=ai_data_bytes
            )
            is None
        )
    ...
    @patch(f"{SCRIPT_LOCATION}.CanAddressingInformation.get_ai_data_bytes_number")
    def test_validate_ai_data_bytes__inconsistent(
        self, mock_get_ai_data_bytes_number, addressing_format, ai_data_bytes, expected_ai_bytes_number
    ):
    ...
    def test_validate_addressing_params(self, mock_ai_mapping, params):
        ...
        assert (
            CanAddressingInformation.validate_addressing_params(**params)
    ...
    @patch(f"{SCRIPT_LOCATION}.CanAddressingInformation.ADDRESSING_INFORMATION_MAPPING")
    def test_is_compatible_can_id__with_addressing_type(
        self, mock_ai_mapping, addressing_format, can_id, addressing_type
    ):
        assert (
            CanAddressingInformation.is_compatible_can_id(
                addressing_format=addressing_format, can_id=can_id, addressing_type=addressing_type
            )
    ...
    @patch(f"{SCRIPT_LOCATION}.CanAddressingInformation.ADDRESSING_INFORMATION_MAPPING")
    def test_is_compatible_can_id__without_addressing_type(self, mock_ai_mapping, addressing_format, can_id):
        assert (
            CanAddressingInformation.is_compatible_can_id(addressing_format=addressing_format, can_id=can_id)
            == mock_ai_mapping.__getitem__.return_value.is_compatible_can_id.return_value
        )
        mock_ai_mapping.__getitem__.assert_called_once_with(addressing_format)
        mock_ai_mapping.__getitem__.return_value.is_compatible_can_id.assert_called_once_with(
    ...
    def test_decode_can_id_ai_params(self, mock_ai_mapping, addressing_format, can_id):
        assert (
            CanAddressingInformation.decode_can_id_ai_params(addressing_format=addressing_format, can_id=can_id)
    ...
    def test_decode_data_bytes_ai_params(self, mock_ai_mapping, addressing_format, ai_data_bytes):
        assert (
            CanAddressingInformation.decode_data_bytes_ai_params(
                addressing_format=addressing_format, ai_data_bytes=ai_data_bytes
            )
    ...
    @pytest.mark.parametrize(
        "addressing_format, can_id, raw_frame_data",
        [
            (Mock(), Mock(), Mock()),
    ...
    def test_decode_frame_ai_params(self, mock_ai_mapping, addressing_format, can_id, raw_frame_data):
        assert (
            CanAddressingInformation.decode_frame_ai_params(
                addressing_format=addressing_format, can_id=can_id, raw_frame_data=raw_frame_data
            )
    ...
    def test_encode_can_id__normal_fixed(self, mock_encode_normal_fixed_can_id, params):
        assert (
            CanAddressingInformation.encode_can_id(
                addressing_format=CanAddressingFormat.NORMAL_FIXED_ADDRESSING, **params
            )
            == mock_encode_normal_fixed_can_id.return_value
        )
        if "priority" in params:
            mock_encode_normal_fixed_can_id.assert_called_once_with(**params)
        else:
            mock_encode_normal_fixed_can_id.assert_called_once_with(
                **params, priority=CanIdHandler.DEFAULT_PRIORITY_VALUE
            )
    ...
    def test_encode_can_id__mixed_29bit(self, mock_encode_normal_fixed_can_id, params):
        assert (
            CanAddressingInformation.encode_can_id(
                addressing_format=CanAddressingFormat.MIXED_29BIT_ADDRESSING, **params
            )
            == mock_encode_normal_fixed_can_id.return_value
        )
        if "priority" in params:
    ...
    def test_encode_ai_data_bytes(self, mock_ai_mapping, addressing_format, target_address, address_extension):
        assert (
            CanAddressingInformation.encode_ai_data_bytes(
...
class TestCanAddressingInformationIntegration:
    ...
    @pytest.mark.parametrize(
        "input_params, expected_attributes",
        [
            # Normal
            (
                {
    ...
    @pytest.mark.parametrize(
        "addressing_format, rx_physical_params, tx_physical_params, "
    ...
    def test_is_input_packet__physical(
        self,
        addressing_format,
        rx_physical_params,
        tx_physical_params,
        ...
        assert (
            addressing_information.is_input_packet(can_id=can_id, raw_frame_data=raw_frame_data)
            is AddressingType.PHYSICAL
        )
    ...
    def test_is_input_packet__functional(
        self,
        addressing_format,
        rx_physical_params,
        tx_physical_params,
    ...
    def test_is_input_packet__none(
        self,
        addressing_format,
        rx_physical_params,
        tx_physical_params,
        ...
        assert addressing_information.is_input_packet(can_id=can_id, raw_frame_data=raw_frame_data) is None
