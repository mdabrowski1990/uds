...
class TestLinkControlIntegration:
    ...
    def test_decode(self, payload, decoded_message):
        output = LINK_CONTROL.decode(payload)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": True, "linkControlType": 0x01},
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": False, "linkControlType": 0x02},
                    "linkRecord": 0x012345,
                },
                RequestSID.LinkControl,
                None,
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": True, "linkControlType": 0x02},
                },
                None,
                ResponseSID.LinkControl,
                bytearray([0xC7, 0x82]),
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert LINK_CONTROL.encode(data_records_values=data_records_values, sid=sid, rsid=rsid) == payload
