...
class TestSecuredDataTransmission2020Integration:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                [0x84, 0x00, 0x19, 0x00, 0x00, 0x00, 0xFE, 0xDC, 0x7D],
                (
                    {
                        "children": (),
                        "length": 8,
            ...
            (
                [0xC4, 0x00, 0x00, 0xFF, 0x00, 0x05, 0x15, 0x9D, 0x3F, 0xBF, 0xCE, 0xB7, 0xE4, 0xEE],
                (
                    {
                        "children": (),
                        "length": 8,
            ...
            (
                [0xC4, 0x7F, 0xFA, 0xD4, 0x00, 0x00, 0x89, 0x58, 0x04, 0xC7, 0x56, 0x63, 0x65, 0xFE, 0x0C, 0xFC],
                (
                    {
                        "children": (),
                        "length": 8,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                RequestSID.SecuredDataTransmission,
                None,
                bytearray([0x84, 0x00, 0x01, 0x3A, 0x00, 0x00, 0x4A, 0xA4, 0x7B]),
            ),
            (
                {
                ...
                bytearray([0xC4, 0xAC, 0x54, 0x63, 0x00, 0x00, 0x30, 0x41, 0x97, 0x76]),
            ),
            (
                {
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert (
            SECURED_DATA_TRANSMISSION_2020.encode(data_records_values=data_records_values, sid=sid, rsid=rsid)
            == payload
        )
...
class TestSecuredDataTransmission2013Integration:
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert (
            SECURED_DATA_TRANSMISSION_2013.encode(data_records_values=data_records_values, sid=sid, rsid=rsid)
            == payload
        )
