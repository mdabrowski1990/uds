...
class TestAuthenticationIntegration:
    ...
    def test_decode(self, payload, decoded_message):
        output = AUTHENTICATION.decode(payload)
    ...
    @pytest.mark.parametrize(
        ...
        [
            # deAuthenticate (0x00)
            (
                {"SubFunction": {"suppressPosRspMsgIndicationBit": True, "authenticationTask": 0x00}},
                RequestSID.Authentication,
                None,
                bytearray([0x29, 0x80]),
            ),
            (
                {"SubFunction": 0x00, "authenticationReturnParameter": 0xFF},
                None,
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": False, "authenticationTask": 0x01},
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": False, "authenticationTask": 0x02},
            ...
            (
                ...
                None,
                ResponseSID.Authentication,
                bytearray([0x69, 0x83, 0x17, 0x00, 0x0A, 0x28, 0x4D, 0x67, 0xE8, 0x81, 0x0E, 0xC6, 0x7F, 0xB6, 0x8C]),
            ),
            # transmitCertificate (0x04)
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": True, "authenticationTask": 0x04},
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": False, "authenticationTask": 0x04},
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": True, "authenticationTask": 0x06},
                    "algorithmIndicator": (
                        0x03,
                        0x8E,
                        0x4C,
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": False, "authenticationTask": 0x06},
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": True, "authenticationTask": 0x08},
                },
                RequestSID.Authentication,
                None,
                bytearray([0x29, 0x88]),
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": False, "authenticationTask": 0x08},
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert AUTHENTICATION.encode(data_records_values=data_records_values, sid=sid, rsid=rsid) == payload
