...
class TestReadDTCInformation2020Integration:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {
                    ...
                    "DTC and DTCSnapshotRecordNumber": [
                        {"DTC": 0xA5B6C7, "DTCSnapshotRecordNumber": 0x00},
                        {"DTC": 0xCAFFEE, "DTCSnapshotRecordNumber": 0xFF},
                    ],
                },
                None,
                ResponseSID.ReadDTCInformation,
            ...
            (
                ...
                ),  # DTCStoredDataRecord#2
            ),
            # reportDTCExtDataRecordByDTCNumber (0x06)
            (
                {"SubFunction": 0x86, "DTC": 0x0000D0, "DTCExtDataRecordNumber": 0xFF},
                RequestSID.ReadDTCInformation,
                None,
            ...
            (
                ...
                bytearray(
                    [
                        ...
                        0x76,
                        0x54,
                        0x00,  # DTC and DTCStatus
                        0x01,
                        0x12,
                        0x34,  # DTCExtendedDataRecord#1
                        0x02,
                        0x34,
                        0x56,  # DTCExtendedDataRecord#2
                        0x43,
                        0x78,
                        0x9A,
                        0xBC,
            ...
            (
                {
                    ...
                    "DTCSeverity, DTCFunctionalUnit, DTC and DTCStatus": [
                        ...
                        0x123456789ABC,
                        {"DTCSeverity": 0x00, "DTCFunctionalUnit": 0x00, "DTC": 0x00FFFF, "DTCStatus": 0xFF},
                    ],
                },
                None,
                ResponseSID.ReadDTCInformation,
                bytearray(
                    [
                        ...
                        0xC3,
                        0xB4,
                        0xA5,  # DTC Severity, DTC Functional Unit, DTC and DTC Status # 1
                        0x12,
                        0x34,
                        0x56,
                        0x78,
                        0x9A,
                        0xBC,  # DTC Severity, DTC Functional Unit, DTC and DTC Status # 2
                        0x00,
                        0x00,
                        0x00,
                        0xFF,
                ...
                ),  # DTC Severity, DTC Functional Unit, DTC and DTC Status # 3
            ),
            # reportSeverityInformationOfDTC (0x09)
            (
                {
            ...
            (
                ...
                None,
                ResponseSID.ReadDTCInformation,
                bytearray([0x59, 0x0A, 0xB7, 0x01, 0x23, 0x45, 0x67, 0xC4, 0xB5, 0xA6, 0x04, 0x97, 0x88, 0x79, 0x6A]),
            ),
            # reportFirstTestFailedDTC (0x0B)
            (
                {
            ...
            (
                ...
                None,
                ResponseSID.ReadDTCInformation,
                bytearray([0x59, 0x8B, 0xFE, 0xF1, 0xE2, 0xD3, 0x88]),
            ),
            # reportFirstConfirmedDTC (0x0C)
            (
                {
            ...
            (
                ...
                None,
                ResponseSID.ReadDTCInformation,
                bytearray([0x59, 0x8D, 0xBB, 0x5A, 0x6B, 0x7C, 0x8F]),
            ),
            # reportMostRecentConfirmedDTC (0x0E)
            (
                {
            ...
            (
                ...
                bytearray(
                    [
                        ...
                        0x00,
                        0x00,
                        0x00,  # DTC and DTCFaultDetectionCounter #1
                        0xFF,
                        0xFF,
                        0xFF,
                        0xFF,  # DTC and DTCFaultDetectionCounter #2
                        0x12,
                        0x34,
                        0x56,
                        0x78,
                    ]
                ),  # DTC and DTCFaultDetectionCounter #3
            ),
            # reportDTCWithPermanentStatus (0x15)
            (
                {
            ...
            (
                ...
                bytearray(
                    [
                        ...
                        0x00,
                        0x00,
                        0x00,  # DTC and DTCStatus #1
                        0x1A,
                        0xB6,
                        0x30,
                        0x96,  # DTC and DTCStatus #2
                        0xFF,
                        0xFF,
                        0xFF,
                        0xFF,
            ...
            (
                ...
                bytearray(
                    [
                        ...
                        0x21,
                        0x43,
                        0x68,  # DTC, Status and ExtendedDataRecord #1
                        0xFE,
                        0xCB,
                        0x98,
                        0x64,
                        0xCA,
                        0xFF,
                        0xEE,  # DTC, Status and ExtendedDataRecord #2
                        0x76,
                        0x54,
                        0x32,
                        0x54,
                ...
                ),  # DTC, Status and ExtendedDataRecord #3
            ),
            # reportUserDefMemoryDTCByStatusMask (0x17)
            (
                {
            ...
            (
                ...
                bytearray(
                    [
                        ...
                        0xDD,
                        0xEE,
                        0x54,  # DTC and DTCStatus #1
                        0xFB,
                        0xBE,
                        0xEF,
                        0x58,  # DTC and DTCStatus #2
                        0x9E,
                        0x8D,
                        0x7C,
                        0x6B,
            ...
            (
                ...
                bytearray(
                    [
                        ...
                        0x98,
                        0xC6,
                        0x5A,  # DTC and DTCStatus
                        0x41,
                        0x21,
                        0x43,  # DTCExtendedDataRecord#1
                        0x78,
                        0x9A,
                        0xBC,
                        0xDE,
            ...
            (
                ...
                bytearray(
                    [
                        ...
                        0xFF,
                        0xEE,
                        0xAB,  # Severity, DTC and DTCStatus #1
                        0x2D,
                        0xF0,
                        0x1E,
                        0xD2,
                        0x3C,  # Severity, DTC and DTCStatus #2
                        0xB4,
                        0x5A,
                        0x96,
                        0x78,
            ...
            (
                ...
                bytearray(
                    [
                        ...
                        0x43,
                        0x65,
                        0x87,  # DTC and DTCStatus #1
                        0xEF,
                        0xCD,
                        0xAB,
                        0x89,  # DTC and DTCStatus #2
                        0x0F,
                        0x1E,
                        0x2D,
                        0x35,
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert READ_DTC_INFORMATION_2020.encode(data_records_values=data_records_values, sid=sid, rsid=rsid) == payload
...
class TestReadDTCInformation2013Integration:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {
                    "SubFunction": 0x83,
                    "DTC and DTCSnapshotRecordNumber": [
                        {"DTC": 0x5A6B7C, "DTCSnapshotRecordNumber": 0x20},
                        {"DTC": 0xCAFFEE, "DTCSnapshotRecordNumber": 0xC2},
                    ],
                },
                None,
                ResponseSID.ReadDTCInformation,
            ...
            # reportDTCStoredDataByRecordNumber (0x05)
            (
                {"SubFunction": 0x05, "DTCStoredDataRecordNumber": 0xFE},
                RequestSID.ReadDTCInformation,
                None,
            ...
            # reportDTCExtDataRecordByDTCNumber (0x06)
            (
                {"SubFunction": 0x06, "DTC": 0xF0E1D2, "DTCExtDataRecordNumber": 0xFF},
                RequestSID.ReadDTCInformation,
                None,
            ...
            (
                {
                    ...
                    "DTCSeverity, DTCFunctionalUnit, DTC and DTCStatus": [
                        {"DTCSeverity": 0xF0, "DTCFunctionalUnit": 0xE1, "DTC": 0xD2C3B4, "DTCStatus": 0xA5},
                        0x123456789ABC,
                        {"DTCSeverity": 0x5A, "DTCFunctionalUnit": 0x69, "DTC": 0x987654, "DTCStatus": 0x89},
                    ],
                },
                None,
                ResponseSID.ReadDTCInformation,
            ...
            (
                ...
                None,
                ResponseSID.ReadDTCInformation,
                bytearray([0x59, 0x8B, 0xFF, 0xF1, 0xE2, 0xD3, 0x89]),
            ),
            # reportFirstConfirmedDTC (0x0C)
            (
                {
            ...
            (
                ...
                None,
                ResponseSID.ReadDTCInformation,
                bytearray([0x59, 0x8D, 0xAF, 0x5A, 0x6B, 0x7C, 0x2B]),
            ),
            # reportMostRecentConfirmedDTC (0x0E)
            (
                {
            ...
            # reportMirrorMemoryDTCByStatusMask (0x0F)
            (
                {"SubFunction": 0x0F, "DTCStatusMask": 0x85},
                RequestSID.ReadDTCInformation,
                None,
            ...
            (
                ...
                None,
                ResponseSID.ReadDTCInformation,
                bytearray([0x59, 0x8F, 0xFF, 0x01, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF]),
            ),
            # reportMirrorMemoryDTCExtDataRecordByDTCNumber (0x10)
            (
                {"SubFunction": 0x10, "DTC": 0x0F1E2D, "DTCExtDataRecordNumber": 0x20},
                RequestSID.ReadDTCInformation,
                None,
            ...
            (
                ...
                bytearray(
                    [
                        ...
                        0xAB,  # DTC and DTCStatus
                        0x50,
                        0xF6,  # DTCExtendedDataRecord#1
                        0x6D,
                        0xBE,
                        0xEF,  # DTCExtendedDataRecord#2
                        0xC2,
                        0x73,
                        0x84,
                        0x95,
            ...
            (
                ...
                bytearray(
                    [
                        ...
                        0x67,
                        0x45,
                        0x23,  # DTC and DTCFaultDetectionCounter #2
                        0xFF,
                        0xFF,
                        0xFF,
                        0xFF,
            ...
            (
                ...
                bytearray(
                    [
                        ...
                        0x89,
                        0x6C,
                        0xA5,  # DTC and DTCStatus
                        0x41,  # DTCExtDataRecordNumber
                        0x21,
                        0x43,  # DTCExtendedDataRecord#1
                        0xF0,
                        0x0F,  # DTCExtendedDataRecord#2
                        0x78,
                        0x9A,
                        0xBC,
                        0xDE,
            ...
            (
                ...
                bytearray(
                    [
                        ...
                        0xDD,
                        0xAD,
                        0x03,  # Severity, DTC and DTCStatus #2
                        0x0F,
                        0xE1,
                        0x2D,
                        0xC3,
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert READ_DTC_INFORMATION_2013.encode(data_records_values=data_records_values, sid=sid, rsid=rsid) == payload
