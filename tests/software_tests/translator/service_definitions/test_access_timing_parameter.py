...
class TestAccessTimingParameter2013Integration:
    ...
    def test_decode(self, payload, decoded_message):
        output = ACCESS_TIMING_PARAMETER_2013.decode(payload)
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert (
            ACCESS_TIMING_PARAMETER_2013.encode(data_records_values=data_records_values, sid=sid, rsid=rsid) == payload
        )
