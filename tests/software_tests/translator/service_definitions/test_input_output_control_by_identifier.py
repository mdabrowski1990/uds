...
class TestInputOutputControlByIdentifier2020Integration:
    ...
    def test_decode(self, payload, decoded_message):
        output = INPUT_OUTPUT_CONTROL_BY_IDENTIFIER_2020.decode(payload)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {"DID": 0xAF1A, "inputOutputControlParameter": 0x01, "controlState": (0xEF,)},
                None,
                ResponseSID.InputOutputControlByIdentifier,
                bytearray([0x6F, 0xAF, 0x1A, 0x01, 0xEF]),
            ),
            # freezeCurrentState (0x02)
            (
                {
            ...
            (
                ...
                RequestSID.InputOutputControlByIdentifier,
                None,
                bytearray([0x2F, 0x32, 0xCB, 0x03, 0x6B, 0x65, 0x01, 0xAD]),
            ),
            (
                {
                    "DID": 0xF186,
                ...
                RequestSID.InputOutputControlByIdentifier,
                None,
                bytearray([0x2F, 0xF1, 0x86, 0x03, 0x60, 0x7F]),
            ),
            (
                {
                    "DID": 0xCDEA,
                ...
                None,
                ResponseSID.InputOutputControlByIdentifier,
                bytearray([0x6F, 0xCD, 0xEA, 0x03, 0x1E, 0xD7, 0x04, 0xF2]),
            ),
        ],
    )
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert (
            INPUT_OUTPUT_CONTROL_BY_IDENTIFIER_2020.encode(data_records_values=data_records_values, sid=sid, rsid=rsid)
            == payload
        )
...
class TestInputOutputControlByIdentifier2013Integration:
    ...
    def test_decode(self, payload, decoded_message):
        output = INPUT_OUTPUT_CONTROL_BY_IDENTIFIER_2013.decode(payload)
        output_dict = tuple(info.to_dict() for info in output)
        assert output_dict == decoded_message
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                None,
                ResponseSID.InputOutputControlByIdentifier,
                bytearray([0x6F, 0xBD, 0xA2, 0x01, 0x11, 0x18, 0xB9, 0x44, 0x10, 0xE8]),
            ),
            # freezeCurrentState (0x02)
            (
                {
            ...
            (
                ...
                ResponseSID.InputOutputControlByIdentifier,
                bytearray(
                    [0x6F, 0xE0, 0xFA, 0x02, 0x85, 0x4B, 0xBE, 0xBE, 0x81, 0x34, 0x62, 0xA2, 0x10, 0x1B, 0xEF, 0x67]
                ),
            ),
            # shortTermAdjustment (0x03)
            (
            ...
            (
                ...
                RequestSID.InputOutputControlByIdentifier,
                None,
                bytearray([0x2F, 0xF1, 0x86, 0x03, 0x40]),
            ),
            (
                {
                    "DID": 0xBA8B,
                ...
                None,
                ResponseSID.InputOutputControlByIdentifier,
                bytearray([0x6F, 0xBA, 0x8B, 0x03, 0x90]),
            ),
        ],
    )
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert (
            INPUT_OUTPUT_CONTROL_BY_IDENTIFIER_2013.encode(data_records_values=data_records_values, sid=sid, rsid=rsid)
            == payload
        )
