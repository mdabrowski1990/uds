...
class TestDynamicallyDefineDataIdentifier2020Integration:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                [0x2C, 0x82, 0xF3, 0xFF, 0x25, 0x92, 0x86, 0x7D, 0xA5, 0xA4, 0x17, 0xCF],
                (
                    {
                        "children": (),
                        "length": 8,
    ...
    def test_decode(self, payload, decoded_message):
        output = DYNAMICALLY_DEFINE_DATA_IDENTIFIER_2020.decode(payload)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                None,
                bytearray([0x2C, 0x81, 0xF2, 0x00, 0xFF, 0xFF, 0xFF, 0x01]),
            ),
            (
                {
                    "SubFunction": 0x01,
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert (
            DYNAMICALLY_DEFINE_DATA_IDENTIFIER_2020.encode(data_records_values=data_records_values, sid=sid, rsid=rsid)
            == payload
        )
...
class TestDynamicallyDefineDataIdentifier2013Integration:
    ...
    @pytest.mark.parametrize(
        ...
        [
            # defineByIdentifier (0x01)
            (
                [0x2C, 0x81, 0xF3, 0xFF, 0xF1, 0x97, 0x6A, 0x83],
                (
                    {
                        "children": (),
                        "length": 8,
    ...
    def test_decode(self, payload, decoded_message):
        output = DYNAMICALLY_DEFINE_DATA_IDENTIFIER_2013.decode(payload)
        output_dict = tuple(info.to_dict() for info in output)
        assert output_dict == decoded_message
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                RequestSID.DynamicallyDefineDataIdentifier,
                None,
                bytearray([0x2C, 0x01, 0xF3, 0x45, 0x43, 0x21, 0x01, 0x2B, 0xF1, 0x9A, 0x1E, 0xD0]),
            ),
            (
                {
                    "SubFunction": {
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert (
            DYNAMICALLY_DEFINE_DATA_IDENTIFIER_2013.encode(data_records_values=data_records_values, sid=sid, rsid=rsid)
            == payload
        )
