...
class TestRoutineControlIntegration:
    ...
    def test_decode(self, payload, decoded_message):
        output = ROUTINE_CONTROL.decode(payload)
    ...
    @pytest.mark.parametrize(
        ...
        [
            # startRoutine (0x01)
            (
                {"SubFunction": {"suppressPosRspMsgIndicationBit": False, "routineControlType": 0x01}, "RID": 0xF0E1},
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": False, "routineControlType": 0x03},
                    "RID": 0xB12C,
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": True, "routineControlType": 0x03},
                    "RID": 0xD07C,
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert ROUTINE_CONTROL.encode(data_records_values=data_records_values, sid=sid, rsid=rsid) == payload
