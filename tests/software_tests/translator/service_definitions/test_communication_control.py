...
class TestCommunicationControlIntegration:
    ...
    def test_decode(self, payload, decoded_message):
        output = COMMUNICATION_CONTROL.decode(payload)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": True, "controlType": 0x05},
                    "communicationType": {
                        "messagesType": 2,
                        "reserved": 0,
                        "networks": 0xA,
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert COMMUNICATION_CONTROL.encode(data_records_values=data_records_values, sid=sid, rsid=rsid) == payload
