...
class TestResponseOnEvent2020Integration:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": True, "eventType": 0x43},
            ...
            (
                ...
                RequestSID.ResponseOnEvent,
                None,
                bytearray([0x86, 0x87, 0xFF, 0xFE, 0xDC, 0xBA, 0x98, 0x76, 0x54, 0x32, 0x10, 0xF1, 0xE2, 0xFF]),
            ),
            (
                {
                    "SubFunction": 0x47,
            ...
            (
                ...
                None,
                ResponseSID.ResponseOnEvent,
                bytearray([0xC6, 0x88, 0x20, 0x4D, 0x8D]),
            ),
            # reportDTCRecordInformationOnDtcStatusChange (0x09)
            (
                {
                ...
                RequestSID.ResponseOnEvent,
                None,
                bytearray([0x86, 0xC9, 0xD4, 0xFE, 0x98, 0xF3, 0x03]),
            ),
            (
                {
                    "SubFunction": {
                        "suppressPosRspMsgIndicationBit": False,
                        "eventType": {"storageState": False, "event": 0x09},
                    },
                    "numberOfIdentifiedEvents": 0x01,
                ...
                None,
                ResponseSID.ResponseOnEvent,
                bytearray([0xC6, 0x09, 0x01, 0x07, 0x96, 0x06, 0x22]),
            ),
        ],
    )
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert RESPONSE_ON_EVENT_2020.encode(data_records_values=data_records_values, sid=sid, rsid=rsid) == payload
...
class TestResponseOnEvent2013Integration:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                ResponseSID.ResponseOnEvent,
                bytearray(
                    [0xC6, 0x02, 0x0F, 0xC1, 0x6E, 0xB5, 0x8F, 0x1A, 0x79, 0xD2, 0x43, 0x41, 0x54, 0x7D, 0x6C, 0x57]
                ),
            ),
            # onChangeOfDataIdentifier (0x03)
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": False, "eventType": 0x03},
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": False, "eventType": 0x45},
            ...
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": False, "eventType": 0x46},
                    "numberOfIdentifiedEvents": 0x00,
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert RESPONSE_ON_EVENT_2013.encode(data_records_values=data_records_values, sid=sid, rsid=rsid) == payload
