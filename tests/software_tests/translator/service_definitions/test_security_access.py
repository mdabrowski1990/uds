...
class TestSecurityAccessIntegration:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                {
                    "SubFunction": {"suppressPosRspMsgIndicationBit": True, "securityAccessType": 0x03},
                },
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert SECURITY_ACCESS.encode(data_records_values=data_records_values, sid=sid, rsid=rsid) == payload
