...
class TestRequestFileTransfer2020Integration:
    ...
    @pytest.mark.parametrize(
        ...
        [
            # AddFile (0x01)
            (
                [0x38, 0x01, 0x00, 0x06, 0x2F, 0x66, 0x2E, 0x31, 0x32, 0x33, 0x8C, 0x01, 0xB0, 0x2C],
                (
                    {
                        "children": (),
                        "length": 8,
            ...
            # ReplaceFile (0x03)
            (
                [0x38, 0x03, 0x00, 0x01, 0x2E, 0x00, 0x01, 0x4F, 0x5B],
                (
                    {
                        "children": (),
                        "length": 8,
            ...
            (
                [0x78, 0x03, 0x06, 0x00, 0x00, 0xB6, 0x70, 0xB2, 0x71, 0xB2],
                (
                    {
                        "children": (),
                        "length": 8,
            ...
            # ReadFile (0x04)
            (
                [0x38, 0x04, 0x00, 0x09, 0x2F, 0x66, 0x69, 0x6C, 0x65, 0x2E, 0x61, 0x62, 0x63, 0x73],
                (
                    {
                        "children": (),
                        "length": 8,
            ...
            (
                [0x78, 0x04, 0x01, 0x40, 0x02, 0x00, 0x02, 0x83, 0x0B, 0x06, 0x97],
                (
                    {
                        "children": (),
                        "length": 8,
            ...
            (
                [0x78, 0x05, 0x02, 0xF0, 0x00, 0xE0, 0x00, 0x02, 0xFE, 0xDC],
                (
                    {
                        "children": (),
                        "length": 8,
            ...
            # ResumeFile (0x06)
            (
                [0x38, 0x06, 0x00, 0x05, 0x2F, 0x66, 0x69, 0x6C, 0x65, 0x00, 0x02, 0x36, 0x3A, 0xBB, 0x6D],
                (
                    {
                        "children": (),
                        "length": 8,
            ...
            (
                [0x78, 0x06, 0x01, 0xD2, 0x00, 0x4E, 0x7D, 0x5C, 0x2D, 0xA9, 0xBC, 0xB1, 0x91],
                (
                    {
                        "children": (),
                        "length": 8,
    ...
    def test_decode(self, payload, decoded_message):
        output = REQUEST_FILE_TRANSFER_2020.decode(payload)
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert REQUEST_FILE_TRANSFER_2020.encode(data_records_values=data_records_values, sid=sid, rsid=rsid) == payload
...
class TestRequestFileTransfer2013Integration:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # DeleteFile (0x02)
            (
                [0x38, 0x02, 0x00, 0x03, 0x41, 0x42, 0x43],
                (
                    {
                        "children": (),
                        "length": 8,
            ...
            # ReadFile (0x04)
            (
                [0x38, 0x04, 0x00, 0x08, 0x66, 0x69, 0x6C, 0x65, 0x2E, 0x78, 0x79, 0x7A, 0x00],
                (
                    {
                        "children": (),
                        "length": 8,
            ...
            (
                [0x78, 0x04, 0x04, 0x77, 0x2B, 0xC3, 0xA1, 0x55, 0x00, 0x01, 0xD6, 0x1B],
                (
                    {
                        "children": (),
                        "length": 8,
            ...
            # ReadDir (0x05)
            (
                [0x38, 0x05, 0x00, 0x0A, 0x2F, 0x73, 0x6F, 0x6D, 0x65, 0x5F, 0x64, 0x69, 0x72, 0x2F],
                (
                    {
                        "children": (),
                        "length": 8,
    ...
    def test_decode(self, payload, decoded_message):
        output = REQUEST_FILE_TRANSFER_2013.decode(payload)
        output_dict = tuple(info.to_dict() for info in output)
        assert output_dict == decoded_message
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert REQUEST_FILE_TRANSFER_2013.encode(data_records_values=data_records_values, sid=sid, rsid=rsid) == payload
