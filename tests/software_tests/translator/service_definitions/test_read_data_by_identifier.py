...
class TestReadDataByIdentifier2020Integration:
            ...
            (
                ...
                (
                    ...
                    },
                    {
                        ...
                        "length": 16,
                        "name": "DID",
                        "physical_value": ("EDRDeviceAddressInformation", "NumberOfEDRDevices", 0x0000, 0xFFFF),
    ...
    def test_decode(self, payload, decoded_message):
        output = READ_DATA_BY_IDENTIFIER_2020.decode(payload)
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert (
            READ_DATA_BY_IDENTIFIER_2020.encode(data_records_values=data_records_values, sid=sid, rsid=rsid) == payload
        )
...
class TestReadDataByIdentifier2013Integration:
    ...
    def test_decode(self, payload, decoded_message):
        output = READ_DATA_BY_IDENTIFIER_2013.decode(payload)
        output_dict = tuple(info.to_dict() for info in output)
        assert output_dict == decoded_message
    ...
    def test_encode(self, data_records_values, sid, rsid, payload):
        assert (
            READ_DATA_BY_IDENTIFIER_2013.encode(data_records_values=data_records_values, sid=sid, rsid=rsid) == payload
        )
