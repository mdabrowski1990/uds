...
# from uds.translator.abstract_database import AbstractDatabase, RequestSID, ResponseSID, UdsMessage, UdsMessageRecord
#
# SCRIPT_LOCATION = "uds.translator.abstract_database"
#
#
