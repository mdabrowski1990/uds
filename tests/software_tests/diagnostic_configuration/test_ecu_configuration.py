...
class TestEcuDiagnosticConfiguration:
    ...
    @pytest.mark.parametrize("states_mapping", [{"State 1": Mock(), "State 2": Mock()}, {"A": Mock(), "B": Mock()}])
    ...
    def test_states__get(self):
        ...
        assert (
            EcuDiagnosticConfiguration.states.fget(self.mock_ecu_diagnostic_configuration)
    ...
    def test_states__set__reassignment_error(self, mock_hasattr):
        ...
        mock_hasattr.assert_called_once_with(
            self.mock_ecu_diagnostic_configuration, f"_{EcuDiagnosticConfiguration.__name__}__states"
        )
    ...
    def test_states_names__get(self):
        ...
        assert (
            EcuDiagnosticConfiguration.states_names.fget(self.mock_ecu_diagnostic_configuration)
    ...
    def test_states_mapping__get(self):
        ...
        assert (
            EcuDiagnosticConfiguration.states_mapping.fget(self.mock_ecu_diagnostic_configuration)
    ...
    def test_sid_restrictions__get(self):
        ...
        assert (
            EcuDiagnosticConfiguration.sid_restrictions.fget(self.mock_ecu_diagnostic_configuration)
    ...
    @pytest.mark.parametrize(
        "is_request_sid, is_response_sid, value",
        [
            (True, False, {1: Mock()}),
    ...
    def test_subfunction_restrictions__get(self):
        ...
        assert (
            EcuDiagnosticConfiguration.subfunction_restrictions.fget(self.mock_ecu_diagnostic_configuration)
    ...
    def test_subfunction_restrictions__set__value_error(self, value):
        ...
        self.mock_is_response_sid.return_value = False
        with pytest.raises(ValueError):
            EcuDiagnosticConfiguration.subfunction_restrictions.fset(
                self.mock_ecu_diagnostic_configuration, value=value
            )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                True,
                {
                    list(SERVICES_WITH_SUBFUNCTION)[-1]: {0x01: Mock()},
    ...
    def test_subfunction_restrictions__set__valid(self, is_request_sid, is_response_sid, value):
        ...
        self.mock_validate_raw_byte.assert_has_calls(
            [
                ...
                for subfunction in subfunction_required_states.keys()
            ],
            any_order=True,
        )
        self.mock_ecu_diagnostic_configuration._EcuDiagnosticConfiguration__validate_required_states.assert_has_calls(
            [
                ...
                for subfunction_required_states in value.values()
                for required_states in subfunction_required_states.values()
            ],
            any_order=True,
        )
    ...
    def test_did_restrictions__get(self):
        ...
        assert (
            EcuDiagnosticConfiguration.did_restrictions.fget(self.mock_ecu_diagnostic_configuration)
    ...
    def test_did_restrictions__set__value_error(self, value):
        ...
        self.mock_is_response_sid.return_value = False
        with pytest.raises(ValueError):
            EcuDiagnosticConfiguration.did_restrictions.fset(self.mock_ecu_diagnostic_configuration, value=value)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                True,
                {
                    list(SERVICES_WITH_DID)[-1]: {0xFFFF: Mock()},
    ...
    def test_did_restrictions__set__valid(self, is_request_sid, is_response_sid, value):
        ...
        self.mock_validate_raw_2byte_value.assert_has_calls(
            [call(did) for did_required_states in value.values() for did in did_required_states.keys()], any_order=True
        )
        self.mock_ecu_diagnostic_configuration._EcuDiagnosticConfiguration__validate_required_states.assert_has_calls(
            [
                call(required_states)
                for did_required_states in value.values()
                for required_states in did_required_states.values()
            ],
            any_order=True,
        )
    ...
    def test_rid_restrictions__get(self):
        ...
        assert (
            EcuDiagnosticConfiguration.rid_restrictions.fget(self.mock_ecu_diagnostic_configuration)
    ...
    def test_rid_restrictions__set__value_error(self, value):
        ...
        self.mock_is_response_sid.return_value = False
        with pytest.raises(ValueError):
            EcuDiagnosticConfiguration.rid_restrictions.fset(self.mock_ecu_diagnostic_configuration, value=value)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                True,
                {
                    list(SERVICES_WITH_RID)[-1]: {0xFFFF: Mock()},
    ...
    def test_rid_restrictions__set__valid(self, is_request_sid, is_response_sid, value):
        ...
        self.mock_validate_raw_2byte_value.assert_has_calls(
            [call(rid) for rid_required_states in value.values() for rid in rid_required_states.keys()], any_order=True
        )
        self.mock_ecu_diagnostic_configuration._EcuDiagnosticConfiguration__validate_required_states.assert_has_calls(
            [
                call(required_states)
                for rid_required_states in value.values()
                for required_states in rid_required_states.values()
            ],
            any_order=True,
        )
    ...
    def test_validate_required_states__valid(self, required_states):
        ...
        self.mock_getitem.assert_has_calls(
            [call(self.mock_ecu_diagnostic_configuration, state_name) for state_name in required_states.keys()],
            any_order=True,
        )
    ...
    def test_extract_subfunction(self, message_payload):
        assert (
            EcuDiagnosticConfiguration._EcuDiagnosticConfiguration__extract_subfunction(message_payload)
    ...
    @pytest.mark.parametrize(
        "states_names, possible_values, restrictions",
        [
            (
                ["State 1", "State 2"],
                [(1, 2, 3, 4, 5), ("ON", "OFF")],
    ...
    def test_combine_restrictions__valid(self, states_names, possible_values, restrictions):
        ...
        assert EcuDiagnosticConfiguration.combine_restrictions(
            self.mock_ecu_diagnostic_configuration, *restrictions
    ...
    def test_get_restrictions__sid_only(self, message_payload):
        ...
        assert (
            EcuDiagnosticConfiguration.get_restrictions(self.mock_ecu_diagnostic_configuration, message_payload)
    ...
    def test_get_restrictions__sid_subfunction(self, message_payload):
        ...
        self.mock_ecu_diagnostic_configuration.combine_restrictions.assert_called_once_with(
            mock_sid_restrictions, mock_subfunction_restrictions
        )

    @pytest.mark.parametrize(
        "message_payload, dids, rids",
        [
...
class TestEcuDiagnosticConfigurationIntegration:
    ...
    def test_init(self):
        ecu_diag_config = EcuDiagnosticConfiguration(
            states=self.EXAMPLE_STATES,
        ...
        assert ecu_diag_config.states_mapping == {state.name: state for state in self.EXAMPLE_STATES}

    @pytest.mark.parametrize(
        "message_payload, message_restrictions",
        [
            (
                [0x10, 0x01],
                {
