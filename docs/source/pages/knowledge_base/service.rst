...
+------------------------------------------------------+-------------+---------------------+----------------------------------------------------------+                                                              |
| DTCSnapshotRecordNumber#n                            | 8           | 0x00 - 0xFF         | Number of Identifiers stored by DTCSnapshot#1 (equals k) | And at least n DTCSnapshot records are available for the DTC |
+---------------------+--------------------------------+-------------+---------------------+----------------------------------------------------------+                                                              |
