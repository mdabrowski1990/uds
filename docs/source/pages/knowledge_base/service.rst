...
.. warning:: In ISO 14229-1 the coefficients C0..Cm “follow” the FormulaIdentifier and are part of scalingByteExtension.
  In the translator (due to code design limitations), scalingByteExtension#n contains only the FormulaIdentifier.
  ...
  Practically, you will see:
    ...
    scalingByte#n (Type=Formula, NumberOfBytes=m+1)
...
+------------------------+------------------------+--------------+--------------------------------+---------------+-----------------------------------------------------------------------------------------------+                                                                         |
|                        | C0#1                   | Exponent     | 4                              | 0x0-0xF       | C0's parameter exponent value encoded as signed value.                                        |                                                                         |
|                        |                        +--------------+--------------------------------+---------------+-----------------------------------------------------------------------------------------------+                                                                         |
|                        |                        | Mantissa     | 12                             | 0x000-0xFFF   | C0's parameter mantissa value encoded as signed value.                                        |                                                                         |
|                        +------------------------+--------------+--------------------------------+---------------+-----------------------------------------------------------------------------------------------+-------------------------------------------------------------------------+
|                        | ...                                                                                                                                                                                                                                                              |
|                        +------------------------+--------------+--------------------------------+---------------+-----------------------------------------------------------------------------------------------+-------------------------------------------------------------------------+
|                        | Cm#1                   | Exponent     | 4                              | 0x0-0xF       | Cm's parameter exponent value encoded as signed value.                                        | If scalingByteExtension#1[FormulaIdentifier] uses at least m constants. |
|                        |                        +--------------+--------------------------------+---------------+-----------------------------------------------------------------------------------------------+                                                                         |
