...
INPUT_OUTPUT_CONTROL_BY_IDENTIFIER_2020 = Service(
    ...
    request_structure=(DID_2020, CONDITIONAL_INPUT_OUTPUT_CONTROL_BY_IDENTIFIER_REQUEST_2020),
    response_structure=(DID_2020, CONDITIONAL_INPUT_OUTPUT_CONTROL_BY_IDENTIFIER_RESPONSE_2020),
)
...
INPUT_OUTPUT_CONTROL_BY_IDENTIFIER_2013 = Service(
    request_sid=RequestSID.InputOutputControlByIdentifier,
    request_structure=(DID_2013, CONDITIONAL_INPUT_OUTPUT_CONTROL_BY_IDENTIFIER_REQUEST_2013),
    response_structure=(DID_2013, CONDITIONAL_INPUT_OUTPUT_CONTROL_BY_IDENTIFIER_RESPONSE_2013),
)
"""Translator for :ref:`InputOutputControlByIdentifier <knowledge-base-service-input-output-control-by-identifier>`
