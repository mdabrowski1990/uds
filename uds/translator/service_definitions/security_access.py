...
SECURITY_ACCESS = Service(request_sid=RequestSID.SecurityAccess,
                          request_structure=(SECURITY_ACCESS_SUBFUNCTION, CONDITIONAL_SECURITY_ACCESS_REQUEST),
                          response_structure=(SECURITY_ACCESS_SUBFUNCTION, CONDITIONAL_SECURITY_ACCESS_RESPONSE))
