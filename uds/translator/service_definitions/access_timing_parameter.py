...
ACCESS_TIMING_PARAMETER_2013 = Service(
    request_sid=RequestSID.AccessTimingParameter,
    request_structure=(ACCESS_TIMING_PARAMETER_SUBFUNCTION_2013, CONDITIONAL_ACCESS_TIMING_PARAMETER_REQUEST_2013),
    response_structure=(ACCESS_TIMING_PARAMETER_SUBFUNCTION_2013, CONDITIONAL_ACCESS_TIMING_PARAMETER_RESPONSE_2013),
)
