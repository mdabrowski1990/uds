...
TRANSFER_DATA = Service(
    request_sid=RequestSID.TransferData,
    request_structure=(BLOCK_SEQUENCE_COUNTER, TRANSFER_REQUEST_PARAMETER),
    response_structure=(BLOCK_SEQUENCE_COUNTER, TRANSFER_RESPONSE_PARAMETER),
)
