...
READ_DATA_BY_PERIODIC_IDENTIFIER = Service(
    request_sid=RequestSID.ReadDataByPeriodicIdentifier,
    request_structure=(TRANSMISSION_MODE, CONDITIONAL_PERIODIC_DID),
