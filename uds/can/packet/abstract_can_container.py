...
class AbstractCanPacketContainer(AbstractPacketContainer, ABC):
    ...
    def data_length(self) -> Optional[int]:
        ...
        Data length is only provided by packets of following types:
         - :ref:`Single Frame <knowledge-base-addressing-single-frame>` -
           :ref:`Single Frame Data Length <knowledge-base-addressing-single-frame-data-length>`
         - :ref:`First Frame <knowledge-base-addressing-first-frame>` -
           :ref:`First Frame Data Length <knowledge-base-addressing-first-frame-data-length>`
    ...
    def payload(self) -> Optional[bytes]:
        ...
        .. warning:: For :ref:`Consecutive Frames <knowledge-base-addressing-consecutive-frame>` this value might contain
    ...
    def flow_status(self) -> Optional[CanFlowStatus]:
        ...
        :ref:`Flow Status <knowledge-base-addressing-flow-status>` is only provided by packets of following types:
         - :ref:`Flow Control <knowledge-base-addressing-flow-control>`
    ...
    def block_size(self) -> Optional[int]:
        ...
        :ref:`Block Size <knowledge-base-addressing-flow-status>` is only provided by packets of following types:
         - :ref:`Flow Control <knowledge-base-addressing-block-size>`
    ...
    def st_min(self) -> Optional[int]:
        ...
        :ref:`STmin <knowledge-base-addressing-st-min>` is only provided by packets of following types:
         - :ref:`Flow Control <knowledge-base-addressing-block-size>`
